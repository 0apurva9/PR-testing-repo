...
import styles from "./ReturnModesForDesktop.css";
...
import { QUICK_DROP, SCHEDULED_PICKUP, SELF_COURIER } from "../../lib/constants";
export default class ReturnModesForDesktop extends React.Component<IProps, IState> {
    constructor(props: IProps) {
        super(props);
        this.state = {
            selectedMode: "",
            isReturnModeSelected: false,
        };
    }
    ...
    private cancelReturnMode = () => {
        this.setState({ selectedMode: "", isReturnModeSelected: false });
    };
    ...
    public render() {
        ...
        return (
            <div className={styles.base}>
                ...
                />
                <div>
                    {this.isReturnModesEnabled() && !this.state.isReturnModeSelected && (
                        <div className={styles.refundableModes}>
                            <div className={styles.header}>
                                {!this.state.isReturnModeSelected && (
                ...
                {!this.isReturnModesEnabled() && (
                    <div className={styles.text}>
                        sorry we are not able to process your request, contact customer care 90291 08282
                    </div>
                )}
            </div>
        );
