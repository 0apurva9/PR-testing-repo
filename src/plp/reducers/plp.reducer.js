...
const productListings = (
    state = {
        ...
        getRestrictedFilterStatus: null,
        getRestrictedFilterLoading: false,
        getRestrictedFilterData: null,
        getRestrictedFilterError: null,
    },
    action
) => {
    ...
    switch (action.type) {
        ...
        case plpActions.SET_FILTER_SELECTED_DATA:
            const selectedFacetKey = state.productListings.facetdata[action.filterTabIndex].key;
            return Object.assign({}, state, {
        ...
        case plpActions.UPDATE_FACETS:
            ...
            if (!productListings) {
                ...
                productListings.facetdatacategory = action.productListings.facetdatacategory;
            }
        ...
        case plpActions.GET_PRODUCT_LISTINGS_PAGINATED_SUCCESS:
            ...
            searchResults = concat(searchResults, action.productListings.searchresult);
        ...
        case plpActions.CHECK_PIN_CODE_FROM_PLP_SUCCESS:
            ...
            if (action.data && action.data.deliveryOptions && action.data.deliveryOptions.pincodeListResponse) {
                pincodeListResponse = action.data.deliveryOptions.pincodeListResponse;
            }
            let serviceableSeller =
                pincodeListResponse &&
                pincodeListResponse.find(seller => {
                    return seller.ussid === action.data.ussId && seller.stockCount > 0 && seller.isServicable === "Y";
                });
            ...
            return Object.assign({}, state, {
                checkPincodeDetailsStatus: action.status,
                checkPincodeDetailsLoading: false,
                checkPincodeFromHaptikChatbot: action.data.checkPincodeFromHaptikChatbot,
        ...
        case plpActions.GET_RESTRICTED_FILTER_REQUEST:
            return Object.assign({}, state, {
                getRestrictedFilterStatus: action.status,
                getRestrictedFilterLoading: true,
            });

        case plpActions.GET_RESTRICTED_FILTER_SUCCESS:
            return Object.assign({}, state, {
                getRestrictedFilterStatus: action.status,
                getRestrictedFilterLoading: false,
                getRestrictedFilterData: action.data,
            });

        case plpActions.GET_RESTRICTED_FILTER_FAILURE:
            return Object.assign({}, state, {
                getRestrictedFilterStatus: action.status,
                getRestrictedFilterLoading: false,
                getRestrictedFilterError: action.error,
            });
        default:
            return state;
    }
