...
import { getFeed, setClickedElementId, setPageFeedSize } from "../actions/home.actions";
...
const HomeContainer = withRouter(connect(mapStateToProps, mapDispatchToProps)(Feed));
