...
export const typeComponentMapping = {
    ...
    AutoWishlist: props => (
        <HomeAutoWishlistComponent {...props} wishListedItem={this.state && this.state.wishListedItem} />
    ),
    ...
    "CMS Text Component": props => {
        ...
        return (
            ...
            parsedContent.map((content, i) => {
                return <CMSTextComponent data={content} key={i} />;
            })
        );
    },
    ...
    renderFeedComponent = index => {
        ...
        return (
            typeComponentMapping[feedDatum.type] && (
                <WidgetContainer {...props} wishListedItem={this.props.wishlistProductId}>
