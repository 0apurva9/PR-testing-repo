...
class ErrorDisplay extends React.Component {
    componentDidUpdate() {
        ...
        if (this.props.userError !== "" && this.props.userError !== null && this.props.userError !== undefined) {
            this.displayError(this.props.userError);
            return;
        }

        if (this.props.plpError !== "" && this.props.plpError !== null && this.props.plpError !== undefined) {
            this.displayError(this.props.plpError);
            return;
        }

        if (this.props.pdpError !== "" && this.props.pdpError !== null && this.props.pdpError !== undefined) {
...
const ErrorContainer = connect(mapStateToProps, mapDispatchToProps)(ErrorDisplay);
