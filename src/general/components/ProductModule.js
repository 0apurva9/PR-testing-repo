...
export default class ProductModule extends React.Component {
    ...
    handleClickOnLink = (event, exchangeOfferAvailable) => {
        if (exchangeOfferAvailable) {
            setDataLayer(ADOBE_CLICK_ON_PRODUCTS_PLP_WITH_EXCHANGE, this.props.productId);
        } else {
            setDataLayer(ADOBE_CLICK_ON_PRODUCTS_PLP_WITHOUT_EXCHANGE, this.props.productId);
        }
    ...
    onClick = () => {
        ...
        if (this.props.onClick) {
            this.props.onClick(this.getProductURL(), null, `ProductModule-${this.props.productId}`);
        }
    };
    ...
    showSimilarIcons = () => {
        let similarButton = this.props.view === "grid" ? styles.display4by4 : styles.display3by3;
    ...
    render() {
        ...
        let rawVariantCount = this.props.variantCount ? this.props.variantCount : "";
        ...
        return (
            <React.Fragment>
                {!electronicView && this.props.shouldShowSimilarIcon && this.showSimilarIcons(electronicView)}
                ...
                <div
                    className={
                        electronicView ? styles.electronicsBase : this.props.autoWidget ? styles.whiteBase : styles.base
                    }
                ...
                >
                    ...
                    >
                        <a href={href} className={styles.aTag} style={{ pointerEvents: "none" }} title={this.props.alt}>
                            <a
                            ...
                            >
                                ...
                                >
                                    ...
                                    {this.props.onConnect && <ConnectButton onClick={this.handleConnect} />}
                    ...
                    <React.Fragment>
                        ...
                        <DesktopOnly>
                            <Link
                                ...
                                target="_blank"
                                title={this.props.alt}
                                onClick={event => this.handleClickOnLink(event, this.props.exchangeOfferAvailable)}
                            >
