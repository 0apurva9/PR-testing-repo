...
export default class DesktopHeader extends React.Component {
    ...
    openSignUpPopUp(value) {
        if (this.props.openSignUp) {
            ...
            setDataLayerForHeaderAndFooterDirectCalls(ADOBE_DIRECT_CALL_FOR_HEADER_CLICK, value);
        }
    }
    ...
    handleSelect() {
        if (this.props.onSelect) {
            this.props.onSelect();
            setDataLayerForMinibag();
            setDataLayerForHeaderAndFooterDirectCalls(ADOBE_DIRECT_CALL_FOR_HEADER_CLICK, "Cart");
        }
    }
    ...
    goToWishList() {
        if (this.props.goToWishList) {
            ...
            setDataLayerForHeaderAndFooterDirectCalls(ADOBE_DIRECT_CALL_FOR_HEADER_CLICK, "Wishlist");
        }
    }
            ...
            if (headerBrandAndCategoryDetails) {
                this.setState({
                    hovered:
                        ...
                        headerBrandAndCategoryDetails.categoriesTabAZListComponent[0].category_name,
                    hoverInType: value,
                });
            }
        }
    ...
    getLuxURL() {
        ...
        switch (hostName) {
            ...
            case "https://deskuat6-tcs.tataunistore.com":
                urlStr = "https://luxuat6-tcs.tataunistore.com";
                break;
            case "https://deskuat6-tcs.tataunistore.com/":
                urlStr = "https://luxuat6-tcs.tataunistore.com/";
                break;
            case "https://www.tatacliq.com/":
                urlStr = "https://luxury.tatacliq.com/";
                break;
            default:
                urlStr = "https://luxury.tatacliq.com/";
        }
    ...
    render() {
        ...
        let currentCategory =
            headerBrandAndCategoryDetails &&
            headerBrandAndCategoryDetails.categoriesTabAZListComponent &&
            headerBrandAndCategoryDetails.categoriesTabAZListComponent.find(categories => {
                        ...
                        <div className={styles.profileWonerHolder}>
                            <div className={styles.signInAndLogout}>
                                <div className={styles.nameAndContact}>
                                    ...
                                    <div className={styles.iconPersonHolder} onClick={() => this.goToMyAccount()} />
                                    <span className={styles.nameSpan}>
                                        {userCookie && userCookie.firstName && <span>{userCookie.firstName}</span>}
                                    </span>
                                    {userCookie &&
                    ...
                    {this.props.isSearch && (
                        <div className={styles.headerFunctionality}>
                            <div className={styles.upperHeader}>
                                <a href={this.getLuxURL()} target="_blank" rel="noreferrer">
                                    {" "}
                                    <div
                                ...
                                <div className={styles.loginAndTrackTab}>
                                    <div className={styles.signInAndLogout}>
                                        ...
                                        {!userCookie && !userCookie && (
                                            <div
                                                ...
                                                onClick={() => this.openSignUpPopUp("Sign in / Sign Up")}
                                            >
                                                Sign in / Sign Up
                                            </div>
                                        )}
                                    ...
                                    <a href={""} target="_blank" rel="noreferrer">
                                        <div
                                            className={styles.loginTab}
                                            onClick={event => this.goToTrackOrders("Track Orders", event)}
                                        >
                                            Track Orders
                                        </div>
                                    </a>
                                    <a href={""} target="_blank" rel="noreferrer">
                                        <div
                                            className={styles.loginTab}
                                            onClick={event => this.renderToAnotherUrlForHelp(HELP_URL, "Help", event)}
                                        >
                                            CLiQ Care
                                        </div>
                                    </a>
                            ...
                            <div className={styles.lowerHeader}>
                                <div className={styles.leftTabHolder}>
                                    {headerBrandAndCategoryDetails &&
                                        headerBrandAndCategoryDetails.categoriesTabAZListComponent &&
                                        headerBrandAndCategoryDetails.categoriesTabAZListComponent.length > 0 && (
                                            <div
                                                className={
                                    ...
                                    {headerBrandAndCategoryDetails &&
                                        headerBrandAndCategoryDetails.brandsTabAZListComponent &&
                                        headerBrandAndCategoryDetails.brandsTabAZListComponent.length > 0 && (
                                            <div
                                                className={
                                ...
                                <div className={styles.rightTabHolder}>
                                    <div
                                        ...
                                        onMouseLeave={() => this.hoverOut()}
                                    >
                                        {this.props.bagCount !== null && this.props.bagCount > 0 && (
                                            <span className={styles.cartCount}>{`${this.props.bagCount}`}</span>
                                        )}
                                        {this.props.minicart && this.props.minicart.products && this.state.bagHover && (
                                            <Minibag cart={this.props.minicart} gotoCart={() => this.handleSelect()} />
                                        )}
                                    </div>
                                    <div className={styles.mywishList} onClick={() => this.goToWishList()}>
                                        {userCookie &&
                                            this.props.wishListCount !== null &&
                                            this.props.wishListCount > 0 && (
                                                <div className={styles.cartCount}>{`${this.props.wishListCount}`}</div>
                                            )}
                                    </div>
                                </div>
                                {this.props.searchHolder && (
                                    <div className={styles.searchHolder}>
                                        <div className={styles.searchWrapper}>{this.props.searchHolder}</div>
                                    </div>
                                )}
                            </div>
                        </div>
...
DesktopHeader.propTypes = {
    ...
    headerBrandAndCategoryDetails: PropTypes.object,
