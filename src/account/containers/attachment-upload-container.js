import { getCustomerQueriesFieldsv2, uploadUserFile, captureAttachmentsSubmit } from "../actions/account.actions";
...
import { showModal, ALERT_POPUP, ATTACHMENT_UPLOAD_RESPONSE_POPUP } from "../../general/modal.actions";
...
const mapStateToProps = state => {
    return {
        ...
        submitCaptureAttachmentsLoading: state.profile.submitCaptureAttachmentsLoading,
...
const AttachmentUploadContainer = connect(mapStateToProps, mapDispatchToProps)(AttachmentUpload);
