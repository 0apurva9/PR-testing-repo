...
import { editAddress, getPinCode, getPinCodeSuccess } from "../actions/account.actions";
...
const EditAddressBookContainer = withRouter(connect(mapStateToProps, mapDispatchToProps)(EditAddressPopUp));
