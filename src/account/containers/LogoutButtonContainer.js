...
import { generateCartIdForAnonymous, getMinicartProducts } from "../../cart/actions/cart.actions";
...
const LogoutButtonContainer = withRouter(connect(mapStateToProps, mapDispatchToProps)(LogoutButton));
