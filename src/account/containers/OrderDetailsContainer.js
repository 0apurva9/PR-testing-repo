...
import { fetchOrderDetails, sendInvoice, fetchOrderItemDetails, retryPayment } from "../actions/account.actions";
...
import { getTitleSuggestions } from "../../pdp/actions/pdp.actions";
...
const OrderDetailsContainer = withRouter(connect(mapStateToProps, mapDispatchToProps)(OrderDetails));
