...
import { SUCCESS, RETURN_SUCCESS_MESSAGE, SUCCESS_CAMEL_CASE, SUCCESS_UPPERCASE } from "../../lib/constants";
...
const ReturnCliqAndPiqContainer = withRouter(connect(mapStateToProps, mapDispatchToProps)(ReturnAddressList));
