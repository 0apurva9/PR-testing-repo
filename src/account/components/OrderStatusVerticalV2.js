...
export default class OrderStatusVerticalV2 extends React.Component {
    ...
    handleMoreDetails(val) {
        ...
        if (this.props.sshipAwbTrackingUrl) {
            this.copySshipAwbTrackingUrl(this.props.sshipAwbTrackingUrl, this.props.trackingAWB);
        } else {
            if (this.props.consignmentStatus == HOTC && this.props.statusDisplay.toUpperCase() !== SHIPPED) {
    ...
    render() {
        ...
        if (orderConfirmedData && orderConfirmedData.value.customerFacingName) {
            orderConfirmedCustomerFacingName = orderConfirmedData.value.customerFacingName;
        }
        if (
            orderConfirmedData &&
            ...
            orderConfirmedDate = orderConfirmedData.value.statusList[0].statusMessageList[0].date;
            orderConfirmedTime = orderConfirmedData.value.statusList[0].statusMessageList[0].time;
        }
        ...
        if (orderInProcessData && orderInProcessData.value.customerFacingName) {
            orderInProcessCustomerFacingName = orderInProcessData.value.customerFacingName;
        }
        if (
            orderInProcessData &&
            ...
            orderInProcessDate = orderInProcessData.value.statusList[0].statusMessageList[0].date;
            orderInProcessTime = orderInProcessData.value.statusList[0].statusMessageList[0].time;
        }
        ...
        if (
            ...
            itemPackedDate =
                itemPackedData.value.statusList[1] && itemPackedData.value.statusList[1].statusMessageList[0].date
                    ? itemPackedData.value.statusList[1].statusMessageList[0].date
                    : itemPackedData.value.statusList[0].statusMessageList[0].date;

            itemPackedTime =
                itemPackedData.value.statusList[1] && itemPackedData.value.statusList[1].statusMessageList[0].time
        ...
        if (
            ...
            //show date time from HOTC or Packed
            shippedDate =
                shippedData.value.statusList[1] && shippedData.value.statusList[1].statusMessageList[0].date
                    ? shippedData.value.statusList[1].statusMessageList[0].date
                    : shippedData.value.statusList[0].statusMessageList[0].date;

            shippedTime =
                shippedData.value.statusList[1] && shippedData.value.statusList[1].statusMessageList[0].time
        ...
        if (outForDeliveryData && outForDeliveryData.value.customerFacingName) {
            outForDeliveryCustomerFacingName = outForDeliveryData.value.customerFacingName;
        }
        if (
            outForDeliveryData &&
        ...
        if (
            ...
            deliveredDate = deliveredData.value.statusList[0].statusMessageList[0].date;
            deliveredTime = deliveredData.value.statusList[0].statusMessageList[0].time;
        }
        //return requested
        ...
        if (returnRequestedData && returnRequestedData.value.customerFacingName) {
            returnRequestedCustomerFacingName = returnRequestedData.value.customerFacingName;
        }
        if (
            returnRequestedData &&
            ...
            returnRequestedDate = returnRequestedData.value.statusList[0].statusMessageList[0].date;
            returnRequestedTime = returnRequestedData.value.statusList[0].statusMessageList[0].time;
        }
        if (returnRequestedData && returnRequestedData.value.statusList && returnRequestedData.value.statusList[0]) {
        ...
        if (notDeliveredData && notDeliveredData.value.customerFacingName) {
            notDeliveredCustomerFacingName = notDeliveredData.value.customerFacingName;
        }
        if (
            notDeliveredData &&
            ...
            notDeliveredDate = notDeliveredData.value.statusList[0].statusMessageList[0].date;
            notDeliveredTime = notDeliveredData.value.statusList[0].statusMessageList[0].time;
            responseCodeForNotDelivered = notDeliveredData.value.statusList[0].responseCode;
        }
        ...
        if (
            ...
            unDeliveredDate = unDeliveredData.value.statusList[0].statusMessageList[0].date;
            unDeliveredTime = unDeliveredData.value.statusList[0].statusMessageList[0].time;
        }
        ...
        if (
            ...
            cancelledDate = cancelledData.value.statusList[0].statusMessageList[0].date;
            cancelledTime = cancelledData.value.statusList[0].statusMessageList[0].time;
        }
        ...
        if (readyForCollectionData && readyForCollectionData.value.customerFacingName) {
            readyForCollectionCustomerFacingName = readyForCollectionData.value.customerFacingName;
        }
        if (
            ...
            readyForCollectionDate = readyForCollectionData.value.statusList[0].statusMessageList[0].date;
            readyForCollectionTime = readyForCollectionData.value.statusList[0].statusMessageList[0].time;
        }
        ...
        if (orderCollectedData && orderCollectedData.value.customerFacingName) {
            orderCollectedCustomerFacingName = orderCollectedData.value.customerFacingName;
        }
        if (
            orderCollectedData &&
            ...
            orderCollectedDate = orderCollectedData.value.statusList[0].statusMessageList[0].date;
            orderCollectedTime = orderCollectedData.value.statusList[0].statusMessageList[0].time;
        }
        ...
        if (orderNotCollectedData && orderNotCollectedData.value.customerFacingName) {
            orderNotCollectedCustomerFacingName = orderNotCollectedData.value.customerFacingName;
        }
        if (
            ...
            orderNotCollectedDate = orderNotCollectedData.value.statusList[0].statusMessageList[0].date;
            orderNotCollectedTime = orderNotCollectedData.value.statusList[0].statusMessageList[0].time;
        }
        ...
        if (returnInitiatedData && returnInitiatedData.value.customerFacingName) {
            returnInitiatedCustomerFacingName = returnInitiatedData.value.customerFacingName;
        }
        if (
            returnInitiatedData &&
            ...
            returnInitiatedDate = returnInitiatedData.value.statusList[0].statusMessageList[0].date;
            returnInitiatedTime = returnInitiatedData.value.statusList[0].statusMessageList[0].time;
        }
        if (returnInitiatedData && returnInitiatedData.value.statusList && returnInitiatedData.value.statusList[0]) {
        ...
        if (returnCancelledData && returnCancelledData.value.customerFacingName) {
            returnCancelledCustomerFacingName = returnCancelledData.value.customerFacingName;
        }
        if (
            returnCancelledData &&
            ...
            returnCancelledDate = returnCancelledData.value.statusList[0].statusMessageList[0].date;
            returnCancelledTime = returnCancelledData.value.statusList[0].statusMessageList[0].time;
        }
        // if (
        //   returnCancelledData &&
        //   returnCancelledData.value.statusList &&
        ...
        if (pickupScheduledData && pickupScheduledData.value.customerFacingName) {
            pickupScheduledCustomerFacingName = pickupScheduledData.value.customerFacingName;
        }
        if (
            pickupScheduledData &&
            ...
            pickupScheduledDate = pickupScheduledData.value.statusList[0].statusMessageList[0].date;
            pickupScheduledTime = pickupScheduledData.value.statusList[0].statusMessageList[0].time;
        }
        if (pickupScheduledData && pickupScheduledData.value.statusList && pickupScheduledData.value.statusList[0]) {
        ...
        let statusList = refundInitiatedData && refundInitiatedData.value && refundInitiatedData.value.statusList;
        let responseCode = "";
        if (refundInitiatedData && refundInitiatedData.value.customerFacingName) {
            refundInitiatedCustomerFacingName = refundInitiatedData.value.customerFacingName;
        }
        if (
            refundInitiatedData &&
            ...
            refundInitiatedDate = refundInitiatedData.value.statusList[0].statusMessageList[0].date;
            refundInitiatedTime = refundInitiatedData.value.statusList[0].statusMessageList[0].time;
        }
        if (refundInitiatedData && refundInitiatedData.value.statusList && refundInitiatedData.value.statusList[0]) {
        ...
        if (returnDeclinedData && returnDeclinedData.value.customerFacingName) {
            returnDeclinedCustomerFacingName = returnDeclinedData.value.customerFacingName;
        }
        ...
        if (
            ...
            returnDeclinedDate = returnDeclinedData.value.statusList[0].statusMessageList[0].date;
            returnDeclinedTime = returnDeclinedData.value.statusList[0].statusMessageList[0].time;
        }
        //refund successful
        ...
        if (refundSuccessfulData && refundSuccessfulData.value.customerFacingName) {
            refundSuccessfulCustomerFacingName = refundSuccessfulData.value.customerFacingName;
        }
        if (
            ...
            refundSuccessfulDate = refundSuccessfulData.value.statusList[0].statusMessageList[0].date;
            refundSuccessfulTime = refundSuccessfulData.value.statusList[0].statusMessageList[0].time;
        }
            ...
            <React.Fragment>
                <div className={styles.base}>
                    ...
                    {this.props.returnMode && this.props.returnType ? (
                      ...
                      {returnRequestedShipmentStatus}
                                    ...
                                    <div className={styles.dateAndTimeHolder}>
                                        <div className={styles.timeHolder}>{returnRequestedTime}</div>
                                        <div className={styles.dateHolder}>{returnRequestedDate}</div>
                                    </div>
                                </div>
                            )}
                            {completedSteps.includes(RETURN_INITIATED) && !this.props.mediationRequired && (
                                <div className={styles.step}>
                                    <div className={styles.checkActive} />
                                    <div
                                        className={
                    ...
                    {returnInitiatedShipmentStatus}
                                    ...
                                    <div className={styles.dateAndTimeHolder}>
                                        <div className={styles.timeHolder}>{returnInitiatedTime}</div>
                                        <div className={styles.dateHolder}>{returnInitiatedDate}</div>
                                    </div>
                                </div>
                            )}
                            ...
                            {completedSteps.includes(REFUND_INITIATED) ? (
                                <React.Fragment>
                                    <div className={styles.step}>
                                        ...
                                        <div className={styles.dateAndTimeHolder}>
                                            <div className={styles.timeHolder}>{refundInitiatedTime}</div>
                                            <div className={styles.dateHolder}>{refundInitiatedDate}</div>
                                        </div>
                                    </div>
                                </React.Fragment>
                            ) : (
                            ...
                            {pickupScheduledShipmentStatus}
                                                    ...
                                                    <div className={styles.dateAndTimeHolder}>
                                                        <div className={styles.timeHolder}>{pickupScheduledTime}</div>
                                                        <div className={styles.dateHolder}>{pickupScheduledDate}</div>
                                                    </div>
                                                </div>
                                            )}
                                        </React.Fragment>
                            ...
                            {completedSteps.includes(RETURN_CANCELLED) ? (
                                <React.Fragment>
                                    <div className={styles.step}>
                                        ...
                                        <div className={styles.dateAndTimeHolder}>
                                            <div className={styles.timeHolder}>{returnCancelledTime}</div>
                                            <div className={styles.dateHolder}>{returnCancelledDate}</div>
                                        </div>
                                    </div>
                                    {returnCancelledCustomerFacingName === "Return Cancelled QC Failed" && (
                                        <div className={styles.step}>
                                            <div className={styles.check} />
                                            <div className={styles.processNameHolder}>Refund Rejected</div>
                                        </div>
                                    )}
                                </React.Fragment>
                            ) : completedSteps.includes(RETURN_DECLINED) ? (
                    ...
                    {returnInitiatedShipmentStatus}
                                        ...
                                        <div className={styles.dateAndTimeHolder}>
                                            <div className={styles.timeHolder}>{returnDeclinedTime}</div>
                                            <div className={styles.dateHolder}>{returnDeclinedDate}</div>
                                        </div>
                                    </div>
                                </React.Fragment>
                            ) : (
                                <div
                                    className={
                                        completedSteps.includes(REFUND_SUCCESSFUL) ? styles.step : styles.stepInactive
                                    }
                                >
                                    <div
                                        className={
                                    ...
                                    <div className={styles.dateAndTimeHolder}>
                                        <div className={styles.timeHolder}>{refundSuccessfulTime}</div>
                                        <div className={styles.dateHolder}>{refundSuccessfulDate}</div>
                                    </div>
                                </div>
                            )}
                        </React.Fragment>
                                    ...
                                    <React.Fragment>
                                        {completedSteps.includes(REFUND_INITIATED) && (
                                            <div className={styles.step}>
                                                ...
                                                <div
                                                    className={
                                                        responseCodeForNotDelivered === "CLOSED_ON_RETURN_TO_ORIGIN" ||
                                                        completedSteps.includes(RETURN_CANCELLED) ||
                                                        completedSteps.includes(RETURN_DECLINED) ||
                                                        completedSteps.includes(REFUND_SUCCESSFUL)
                                                            ? styles.processNameHolder
                                        ...
                                        {this.props.paymentMethod === CASH_ON_DELIVERY &&
                                            ...
                                            responseCodeForNotDelivered === "CLOSED_ON_RETURN_TO_ORIGIN" && (
                                                <div className={styles.step}>
                                                    ...
                                                    <div className={styles.dateAndTimeHolder}>
                                                        <div className={styles.timeHolder}>{notDeliveredTime}</div>
                                                        <div className={styles.dateHolder}>{notDeliveredDate}</div>
                                                    </div>
                                                </div>
                                            )}
                                        ...
                                        <React.Fragment>
                                            ...
                                            {completedSteps.includes(ORDER_NOT_COLLECTED) ? (
                                                ...
                                                >
                                                    ...
                                                    <div className={styles.dateAndTimeHolder}>
                                                        <div className={styles.timeHolder}>{orderNotCollectedTime}</div>
                                                        <div className={styles.dateHolder}>{orderNotCollectedDate}</div>
                                                    </div>
                                                </div>
                                            ) : (
                                                <div
                                                ...
                                                >
                                                    ...
                                                    <div className={styles.dateAndTimeHolder}>
                                                        <div className={styles.timeHolder}>{orderCollectedTime}</div>
                                                        <div className={styles.dateHolder}>{orderCollectedDate}</div>
                                                    </div>
                                                </div>
                                            )}
                                        </React.Fragment>
