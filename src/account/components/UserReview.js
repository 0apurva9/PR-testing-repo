...
import styles from "./UserReview.css";
...
export default class UserReview extends React.Component {
    ...
    handleScroll = () => {
        return throttle(() => {
            if (this.props.userReview && this.props.userReview.pageNumber + 1 < this.props.userReview.totalNoOfPages) {
                const windowHeight =
    ...
    render() {
        ...
        return (
            <div className={styles.base}>
                {this.props && this.props.userReview && this.props.userReview.reviews ? (
                    <React.Fragment>
                        <MobileOnly>
