...
export default class AttachmentUpload extends Component {
    ...
    async onUploadFile(file, { maxFileLimit, maxFileSize, title }) {
        const errorData = this.props.customerQueriesField ? this.props.customerQueriesField.find(item => item.componentName === "errorComponent") : {};
    ...
    render() {
        ...
        const { customerQueriesLoading, uploadUserFileLoading, submitCaptureAttachmentsLoading, customerQueriesField } = this.props
        if (customerQueriesLoading || uploadUserFileLoading || submitCaptureAttachmentsLoading) {
            this.props.showSecondaryLoader();
        } else {
            this.props.hideSecondaryLoader();
        }
        const attachmentData = customerQueriesField ? customerQueriesField.find(item => item.componentName === "attachmentComponent") : {};
        const labelData = customerQueriesField ? customerQueriesField.find(item => item.componentName === "labelComponent") : {};
        return (
