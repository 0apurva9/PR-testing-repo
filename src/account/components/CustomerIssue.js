            ...
            <div>
                ...
                {!this.props.orderAllList && (
                    <div className={styles.base}>
                                ...
                                <div className={styles.whiteCard}>
                                    {!this.props.isUserLogin ? (
                                        <div className={styles.loginBox}>
                                            ...
                                            <div className={styles.loginHeading}>Need help with recent orders?</div>
                        ...
                        {this.props.orderList && (
                            <OtherQuestionsList
                                customerQueriesOtherIssueData={this.props.customerQueriesOtherIssueData}
                        ...
                        {this.props.isOrderDatails && (
                            <OrderListDetails
                                ...
                                selectQuestion={(listOfIssue, index) => this.props.selectQuestion(listOfIssue, index)}
                                ...
                                submitCustomerForms={formaData => this.props.submitCustomerForms(formaData)}
                                displayToast={message => this.props.displayToast(message)}
                                customerQueriesField={this.props.customerQueriesField}
                                getCustomerQueriesFields={(webFormTemplate, isIssueOptions) =>
                                    this.props.getCustomerQueriesFields(webFormTemplate, isIssueOptions)
                                }
