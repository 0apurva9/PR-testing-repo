                ...
                <div className={styles.userProfileHolder}>
                    <div className={styles.iconHolder}>
                        ...
                        {(this.props.image || name) && (
                            <div className={styles.userWithOutIcon}>
                                ...
                                {name && name !== "undefined" && (
                                    <div className={styles.accountImageText}>{this.props.firstName}</div>
                                )}
                            </div>
                        )}
                        {!this.props.image && !this.props.firstName && !this.props.lastName && (
                    ...
                    <div className={styles.headindTextWithLink}>
                        <div className={styles.headingText}>
                            ...
                            {this.props.lastName && this.props.lastName !== "undefined" && this.props.lastName}
                        </div>
                                ...
                                .map((datum, i) => {
                                    return (
                                        <div className={styles.addressWrap} key={i}>
                                            {datum.addressType && (
                                                <div className={styles.defaultAddressHeader}>{datum.addressType}</div>
                                            )}
                                            <div className={styles.addressLine1}>{datum.line1}</div>
                                            <div className={styles.addressLine1}>{datum.landmark}</div>
                                            <div className={styles.addressLine1}>
                                                {`${datum.state},${datum.postalCode} ,${datum.town}`}
                                            </div>

                                            <div className={styles.addressLine1}>{`ph :${datum.phone}`}</div>
                                        </div>
                                    );
                                })}
                    </div>
