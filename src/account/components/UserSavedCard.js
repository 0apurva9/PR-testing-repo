...
import { CUSTOMER_ACCESS_TOKEN, LOGGED_IN_USER_DETAILS, SAVED_PAYMENTS } from "../../lib/constants";
...
import { setDataLayer, ADOBE_MY_ACCOUNT_SAVED_PAYMENTS } from "../../lib/adobeUtils";
                  ...
                  />
                            ...
                            {this.state.showAddNewUpi === 1 && (
                                <div className={styles.saveCardDetailWithHolder}>
                                    ...
                                    {this.state.isSavedCardTab === 0 &&
                                        this.props.profile.savedCards.savedCardDetailsMap &&
                                        this.props.profile.savedCards.savedCardDetailsMap.length !== 0 &&
                                        this.props.profile.savedCards.savedCardDetailsMap.map((data, i) => {
                                            ...
                                            let cardHolderName = data.value.nameOnCard ? data.value.nameOnCard : "";
                                            return (
                                    ...
                                    {this.state.isSavedCardTab === 1 &&
                                        ...
                                        this.props.profile.savedCards.savedUPIDetailsMap.map((data, i) => {
