...
const account = (
    ...
    switch (action.type) {
        ...
        case accountActions.GET_ALL_ORDERS_SUCCESS:
            let currentOrderDetailObj = state.orderDetails ? cloneDeep(state.orderDetails) : {};
            if (action.isPaginated && currentOrderDetailObj && currentOrderDetailObj.orderData) {
                currentOrderDetailObj.orderData = currentOrderDetailObj.orderData.concat(action.orderDetails.orderData);
                currentOrderDetailObj.currentPage = currentOrderDetailObj.currentPage + 1;
            } else {
        ...
        case accountActions.GET_ALL_SELLERS_SUCCESS:
            let currentSellerDetailObj = state.sellerDetails ? cloneDeep(state.sellerDetails) : {};
        ...
        case accountActions.GET_ALL_SELLERS_REVIEW_SUCCESS:
            let currentSellerReviewDetailObj = state.sellerReviewDetails ? cloneDeep(state.sellerReviewDetails) : {};
            if (currentSellerReviewDetailObj && currentSellerReviewDetailObj.sellerData) {
        ...
        case accountActions.GET_USER_CLIQ_CASH_EXPIRING_DETAILS_SUCCESS:
            ...
            if (expDetails.expiryDate && expDetails.expiryTime && expDetails.amount.value) {
        ...
        case accountActions.REMOVE_ADDRESS_SUCCESS:
            ...
            const indexOfAddressToBeRemove = currentAddresses.addresses.findIndex(address => {
        ...
        case accountActions.UPDATE_PROFILE_SUCCESS:
            ...
            updateUserDetails.firstName =
                action.userDetails.firstName !== undefined && action.userDetails.firstName !== "undefined"
                    ? action.userDetails.firstName
                    : "";
            updateUserDetails.lastName =
                action.userDetails.lastName !== undefined && action.userDetails.lastName !== "undefined"
                    ? action.userDetails.lastName
                    : "";
            Cookies.createCookie(LOGGED_IN_USER_DETAILS, JSON.stringify(updateUserDetails));
            return Object.assign({}, state, {
                updateProfileStatus: action.status,
                userDetails: action.userDetails,
                loading: false,
        ...
        case accountActions.RETURN_PIN_CODE_FAILURE:
            ...
            updatedReturnProductDetails.returnModes = action.pinCodeDetails && action.pinCodeDetails.returnModes;
            return Object.assign({}, state, {
                returnPinCodeStatus: action.status,
        ...
        case accountActions.GET_ORDERS_TRANSACTION_DATA_SUCCESS:
            let currentOrderTransactionDetailObj = state.ordersTransactionData
                ...
                : {};
            if (action.isPaginated && currentOrderTransactionDetailObj && currentOrderTransactionDetailObj.orderData) {
                ...
                currentOrderTransactionDetailObj.currentPage = currentOrderTransactionDetailObj.currentPage + 1;
            } else {
        ...
        case accountActions.GET_USER_REVIEW_SUCCESS:
            ...
            if (action.userReview.pageNumber === 0) {
                updatedReviewsObj = Object.assign({}, currentReviews, action.userReview);
            } else {
                let updatedReviews = concat(currentReviews.reviews, action.userReview.reviews);
        ...
        case accountActions.RETRY_PAYMENT_RELEASE_BANK_OFFER_SUCCESS:
            cloneRetryPaymentDetails = state.retryPaymentDetails ? cloneDeep(state.retryPaymentDetails) : {};
        ...
        case accountActions.TICKET_RECENT_HISTORY_DETAILS_SUCCESS:
            ...
            if (action.isPaginated && ticketHistoryDetailsObj && ticketHistoryDetailsObj.tickets) {
                ticketHistoryDetailsObj.tickets = ticketHistoryDetailsObj.tickets.concat(action.ticketDetails.tickets);
                ticketHistoryDetailsObj.currentPage = ticketHistoryDetailsObj.currentPage + 1;
            } else {
