...
export function setDataLayerForRatingAndReview(type, ratingObj) {
  ...
  if (type === SET_DATA_LAYER_RATING_MESSAGE) {
    Object.assign(previousDigitalData.rating, {
      message: { value: ratingObj.statusText }
    });
    if (window._satellite) {
