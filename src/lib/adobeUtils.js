...
export const ADOBE_TARGET_COOKIE_NAME = "AMCV_E9174ABF55BA76BA7F000101%40AdobeOrg";
...
export const SET_DATA_LAYER_ADD_GIFT_CARD_SUBMIT = "SET_DATA_LAYER_ADD_GIFT_CARD_SUBMIT";
export const SET_DATA_LAYER_BUY_GIFT_CARD_SUBMIT = "SET_DATA_LAYER_BUY_GIFT_CARD_SUBMIT";
export const SET_DATA_LAYER_CLIQ_CASH_LAST_FIVE_TRANSACTION = "SET_DATA_LAYER_CLIQ_CASH_LAST_FIVE_TRANSACTION";
export const SET_DATA_LAYER_CLIQ_CASH_VIEW_ALL_TRANSACTION = "SET_DATA_LAYER_CLIQ_CASH_VIEW_ALL_TRANSACTION";
...
const ADOBE_DIRECT_CALL_FOR_CHANGE_QUANTITY_ON_CART = "cpj_cart_quantity_change";
...
const ADOBE_CHECKOUT_APPLY_COUPON_SUCCESS = "cpj_checkout_payment_coupon_success";
...
export const ADOBE_INTERNAL_SEARCH_CALL_ON_GET_PRODUCT = "ADOBE_INTERNAL_SEARCH_CALL_ON_GET_PRODUCT";
export const ADOBE_INTERNAL_SEARCH_CALL_ON_GET_PRODUCT_SP = "Search_History";
export const ADOBE_INTERNAL_SEARCH_CALL_ON_GET_PRODUCT_TRENDING = "Trending_Now";
export const ADOBE_INTERNAL_SEARCH_CALL_ON_GET_PRODUCT_RECENT = "PDP_Recently_Viewed";
export const ADOBE_INTERNAL_SEARCH_CALL_ON_GET_NULL = "ADOBE_INTERNAL_SEARCH_CALL_ON_GET_NULL";
...
export const SET_DATA_LAYER_FOR_ADD_TO_BAG_EVENT = "SET_DATA_LAYER_FOR_ADD_TO_BAG_EVENT";
export const SET_DATA_LAYER_FOR_ADOBE_ADD_TO_CART_BUTTON = "SET_DATA_LAYER_FOR_ADOBE_ADD_TO_CART_BUTTON";
export const SET_DATA_LAYER_FOR_SIZE_GUIDE = "SET_DATA_LAYER_FOR_SIZE_GUIDE";
export const SET_DATA_LAYER_FOR_BUY_NOW_EVENT = "SET_DATA_LAYER_FOR_BUY_NOW_EVENT";

export const SET_DATA_LAYER_FOR_SAVE_PRODUCT_EVENT_ON_PDP = "SET_DATA_LAYER_FOR_SAVE_PRODUCT_EVENT_ON_PDP";
export const SET_DATA_LAYER_FOR_EMI_BANK_EVENT = "SET_DATA_LAYER_FOR_EMI_BANK_EVENT";
export const ADOBE_DIRECT_CALLS_FOR_REMOVE_PRODUCT_ON_CART = "ADOBE_DIRECT_CALLS_FOR_REMOVE_PRODUCT_ON_CART";

export const SET_DATA_LAYER_FOR_REVIEW_AND_RATING_EVENT = "SET_DATA_LAYER_FOR_REVIEW_AND_RATING_EVENT";
export const SET_DATA_LAYER_FOR_VIEW_ALL_REVIEW_AND_RATING_EVENT =
    "SET_DATA_LAYER_FOR_VIEW_ALL_REVIEW_AND_RATING_EVENT";
export const SET_DATA_LAYER_FOR_SUBMIT_REVIEW = "SET_DATA_LAYER_FOR_SUBMIT_REVIEW";
export const SET_DATA_LAYER_FOR_WRITE_REVIEW_EVENT = "SET_DATA_LAYER_FOR_WRITE_REVIEW_EVENT";

export const ADOBE_REMOVE_ITEM = "ADOBE_REMOVE_ITEM";
export const ADOBE_CALLS_FOR_ON_CLICK_CHECKOUT = "ADOBE_CALLS_FOR_ON_CLICK_CHECKOUT";
export const ADOBE_CALLS_FOR_CHANGE_QUANTITY = "ADOBE_CALLS_FOR_CHANGE_QUANTITY";
export const ADOBE_CALLS_FOR_APPLY_COUPON_SUCCESS = "ADOBE_CALLS_FOR_APPLY_COUPON_SUCCESS";
export const ADOBE_CALLS_FOR_APPLY_COUPON_FAIL = "ADOBE_CALLS_FOR_APPLY_COUPON_FAIL";
export const ADOBE_DIRECT_CALL_FOR_SAVE_ITEM_ON_CART = "ADOBE_DIRECT_CALL_FOR_SAVE_ITEM_ON_CART";

export const ADOBE_DIRECT_CALLS_FOR_ORDER_CONFIRMATION_SUCCESS = "ADOBE_DIRECT_CALLS_FOR_ORDER_CONFIRMATION_SUCCESS";
export const ADOBE_DIRECT_CALLS_FOR_ORDER_CONFIRMATION_FAILURE = "ADOBE_DIRECT_CALLS_FOR_ORDER_CONFIRMATION_FAILURE";

//  constants for checkout pages
export const ADOBE_CHECKOUT_DEFAULT_NEW_ADDRESS = "ADOBE_CHECKOUT_DEFAULT_NEW_ADDRESS";
export const ADOBE_LANDING_ON_ADDRESS_TAB_ON_CHECKOUT_PAGE = "ADOBE_LANDING_ON_ADDRESS_TAB_ON_CHECKOUT_PAGE";
export const ADOBE_ADD_NEW_ADDRESS_ON_CHECKOUT_PAGE = "ADOBE_ADD_NEW_ADDRESS_ON_CHECKOUT_PAGE";
export const ADOBE_ADD_NEW_ADDRESS_ON_MY_ACCOUNT_PAGE = "ADOBE_ADD_NEW_ADDRESS_ON_MY_ACCOUNT_PAGE";
...
export const ADOBE_CALL_FOR_LANDING_ON_PAYMENT_MODE = "ADOBE_CALL_FOR_LANDING_ON_PAYMENT_MODE";
export const ADOBE_CALL_FOR_SELECTING_PAYMENT_MODES = "ADOBE_CALL_FOR_SELECTING_PAYMENT_MODES";
export const ADOBE_CALL_FOR_SELECT_DELIVERY_MODE = "ADOBE_CALL_FOR_SELECT_DELIVERY_MODE";
export const ADOBE_CALL_FOR_PROCCEED_FROM_DELIVERY_MODE = "ADOBE_CALL_FOR_PROCCEED_FROM_DELIVERY_MODE";
export const ADOBE_CALL_FOR_SEE_ALL_BANK_OFFER = "ADOBE_CALL_FOR_SEE_ALL_BANK_OFFER";

export const ADOBE_CALL_FOR_CLIQ_CASH_TOGGLE_ON = "ADOBE_CALL_FOR_CLIQ_CASH_TOGGLE_ON";
export const ADOBE_CALL_FOR_CLIQ_CASH_TOGGLE_OFF = "ADOBE_CALL_FOR_CLIQ_CASH_TOGGLE_OFF";
export const ADOBE_CALL_FOR_APPLY_COUPON_SUCCESS = "ADOBE_CALL_FOR_APPLY_COUPON_SUCCESS";
export const ADOBE_CALL_FOR_APPLY_COUPON_FAILURE = "ADOBE_CALL_FOR_CLIQ_CASH_TOGGLE_FAILURE";
export const ADOBE_CALL_FOR_CLIQ_AND_PICK_APPLIED = "ADOBE_CALL_FOR_CLIQ_AND_PICK_APPLIED";
...
export const WHATSAPP_NOTIFICATION_UNCHECKED = "WHATSAPP_NOTIFICATION_UNCHECKED";

// end of constants for checkout pages

// const for setting data layer for the login track

export const ADOBE_DIRECT_CALL_FOR_LOGIN_SUCCESS = "ADOBE_DIRECT_CALL_FOR_LOGIN_SUCCESS";
export const ADOBE_DIRECT_CALL_FOR_LOGIN_FAILURE = "ADOBE_DIRECT_CALL_FOR_LOGIN_FAILURE";
export const ADOBE_DIRECT_CALL_FOR_ANONYMOUS_USER = "ADOBE_DIRECT_CALL_FOR_ANONYMOUS_USER";
...
export const ADOBE_MY_ACCOUNT_SAVED_PAYMENTS = "ADOBE_MY_ACCOUNT_SAVED_PAYMENTS";
...
export const ADOBE_DIRECT_CALL_FOR_PINCODE_SUCCESS = "ADOBE_DIRECT_CALL_FOR_PINCODE_SUCCESS";
export const ADOBE_DIRECT_CALL_FOR_PINCODE_FAILURE = "ADOBE_DIRECT_CALL_FOR_PINCODE_FAILURE";

// const for myAccount adobe calls
export const ADOBE_MY_ACCOUNT_CANCEL_ORDER_SUCCESS = "ADOBE_MY_ACCOUNT_CANCEL_ORDER_SUCCESS";
export const ADOBE_MY_ACCOUNT_ORDER_RETURN_CANCEL = "ADOBE_MY_ACCOUNT_ORDER_RETURN_CANCEL";
...
export const ADOBE_ON_FOLLOW_AND_UN_FOLLOW_BRANDS = "ADOBE_ON_FOLLOW_AND_UN_FOLLOW_BRANDS";
...
export const ADOBE_DIRECT_CALL_FOR_HEADER_CLICK = "ADOBE_DIRECT_CALL_FOR_HEADER_CLICK";
export const ADOBE_LOGOUT_SUCCESSFULL = "ADOBE_LOGOUT_SUCCESSFULL";
export const ADOBE_DIRECT_CALL_FOR_CHOOSE_DELIVERY_ADDRESS_HOME = "ADOBE_DIRECT_CALL_FOR_CHOOSE_DELIVERY_ADDRESS_HOME";
export const ADOBE_DIRECT_CALL_FOR_CHOOSE_DELIVERY_ADDRESS_OFFICE =
    "ADOBE_DIRECT_CALL_FOR_CHOOSE_DELIVERY_ADDRESS_OFFICE";
export const ADOBE_DIRECT_CALL_FOR_FILTER_OPTION = "ADOBE_DIRECT_CALL_FOR_FILTER_OPTION";
export const ADOBE_DIRECT_CALL_FOR_CATEGORY_CLICK = "ADOBE_DIRECT_CALL_FOR_CATEGORY_CLICK";
export const ADOBE_DIRECT_CALL_FOR_BRAND_CLICK = "ADOBE_DIRECT_CALL_FOR_BRAND_CLICK";
export const ADOBE_DIRECT_CALL_FOR_FOOTER_CLICK = "ADOBE_DIRECT_CALL_FOR_FOOTER_CLICK";
export const ADOBE_DIRECT_CALL_FOR_SOCIALMEDIA_CLICK = "ADOBE_DIRECT_CALL_FOR_SOCIALMEDIA_CLICK";
export const ADOBE_DIRECT_CALL_FOR_FOOTER_SUBSCRIBE = "ADOBE_DIRECT_CALL_FOR_FOOTER_SUBSCRIBE";
export const ADOBE_DIRECT_CALL_FOR_GO_TO_BAG = "ADOBE_DIRECT_CALL_FOR_GO_TO_BAG";
export const ADOBE_DIRECT_CALL_FOR_EMI_VIEW_PLAN = "ADOBE_DIRECT_CALL_FOR_EMI_VIEW_PLAN";
export const ADOBE_DIRECT_CALL_FOR_PICK_UP_OPTION = "ADOBE_DIRECT_CALL_FOR_PICK_UP_OPTION";
export const ADOBE_DIRECT_CALL_FOR_PDP_OFFER = "ADOBE_DIRECT_CALL_FOR_PDP_OFFER";
export const ADOBE_DIRECT_CALL_FOR_PDP_PRODUCT_PLUS_VIEW_MORE = "ADOBE_DIRECT_CALL_FOR_PDP_PRODUCT_PLUS_VIEW_MORE";
export const ADOBE_DIRECT_CALL_FOR_PDP_SPEC_VIEW_MORE = "ADOBE_DIRECT_CALL_FOR_PDP_SPEC_VIEW_MORE";
export const ADOBE_DIRECT_CALL_FOR_SELECT_STORE = "ADOBE_DIRECT_CALL_FOR_SELECT_STORE";
export const ADOBE_HELP = "ADOBE_HELP";
export const ADOBE_DIRECT_CALL_FOR_FRESH_FROM_BRANDS_PDP_VIEW = "ADOBE_DIRECT_CALL_FOR_FRESH_FROM_BRANDS_PDP_VIEW";
export const ADOBE_DIRECT_CALL_FOR_CART_SAVED_LIST = "ADOBE_DIRECT_CALL_FOR_CART_SAVED_LIST";
export const ADOBE_DIRECT_CALL_FOR_CART_FOOTER_LINK_CLICK = "ADOBE_DIRECT_CALL_FOR_CART_FOOTER_LINK_CLICK";
export const ADOBE_DIRECT_CALL_FOR_REVIEW_RATE_THE_PRODUCT = "ADOBE_DIRECT_CALL_FOR_REVIEW_RATE_THE_PRODUCT";
export const ADOBE_LOGIN_START = "ADOBE_LOGIN_START";
export const ADOBE_MY_ACCOUNT_WISHLIST_REMOVE = "ADOBE_MY_ACCOUNT_WISHLIST_REMOVE";
...
const AUTOMATED_BRAND_PRODUCT_CAROUSAL_ADOBE = "automated_brand_product_carousal";
...
export const ADOBE_DIRECT_CALL_FOR_CONTINUE_SHOPPING = "ADOBE_DIRECT_CALL_FOR_CONTINUE_SHOPPING";
...
export const ADOBE_BUNDLED_ADD_BOTH_PRODUCT_TO_CART = "ADOBE_BUNDLED_ADD_BOTH_PRODUCT_TO_CART";
export const ADOBE_BUNDLED_ADD_TO_CONTINUE_CLICK = "ADOBE_BUNDLED_ADD_TO_CONTINUE_CLICK";
export const ADOBE_VIRTUAL_PAGELOAD = "ADOBE_VIRTUAL_PAGELOAD";

//return flow
const ORDER_DETAILS_LINK_CLICKED = "myAccount_orderDetails";
export const ADOBE_ORDER_DETAILS_LINK_CLICKED = "ADOBE_ORDER_DETAILS_LINK_CLICKED";
const ITEM_DETAILS_LINK_CLICKED = "myAccount_itemDetails";
export const ADOBE_ITEM_DETAILS_LINK_CLICKED = "ADOBE_ITEM_DETAILS_LINK_CLICKED";
...
export const ADOBE_REQUEST_INVOICE_LINK_CLICKED = "ADOBE_REQUEST_INVOICE_LINK_CLICKED";
const HELP_SUPPORT_LINK_CLICKED = "rrj_helpSupport_click";
export const ADOBE_HELP_SUPPORT_LINK_CLICKED = "ADOBE_HELP_SUPPORT_LINK_CLICKED";
const MY_ACCOUNT_HELP_AND_SUPPORT = "myAccount_helpSupport_click";
export const ADOBE_MY_ACCOUNT_HELP_AND_SUPPORT = "ADOBE_MY_ACCOUNT_HELP_AND_SUPPORT";
const RETURN_REASON_BUTTON_CLICKED = "rrj_returnReason_click";
export const ADOBE_RETURN_REASON_BUTTON_CLICKED = "ADOBE_RETURN_REASON_BUTTON_CLICKED";
...
export const ADOBE_REFUNDSUMMARY_ORDERDETAILS_BUTTON_CLICKED = "ADOBE_REFUNDSUMMARY_ORDERDETAILS_BUTTON_CLICKED";
...
export const ADOBE_REFUNDSUMMARY_PAGE_LANDED = "ADOBE_REFUNDSUMMARY_PAGE_LANDED";
const ADD_BANKDETAILS_BUTTON_CLICKED = "rrj_addBankDetails_click";
export const ADOBE_ADD_BANKDETAILS_BUTTON_CLICKED = "ADOBE_ADD_BANKDETAILS_BUTTON_CLICKED";
const CHANGE_PICKUPADDRESS_LINK_CLICKED = "rrj_changeAddress_click";
export const ADOBE_CHANGE_PICKUPADDRESS_LINK_CLICKED = "ADOBE_CHANGE_PICKUPADDRESS_LINK_CLICKED";
const SAVE_BANKDETAILS_BUTTON_CLICKED = "rrj_addBankContinue_click";
export const ADOBE_SAVE_BANKDETAILS_BUTTON_CLICKED = "ADOBE_SAVE_BANKDETAILS_BUTTON_CLICKED";
const SHOW_REFUND_BUTTON_CLICKED = "rrj_refund_click";
export const ADOBE_SHOW_REFUND_BUTTON_CLICKED = "ADOBE_SHOW_REFUND_BUTTON_CLICKED";
...
const MYACCOUNT_DELIVERYMODE_CHANGE_INITIATE = "cpj_myacc_changeDeliveryMode_initiate";
export const ADOBE_MYACCOUNT_DELIVERYMODE_CHANGE_INITIATE = "ADOBE_MYACCOUNT_DELIVERYMODE_CHANGE_INITIATE";
const MYACCOUNT_DELIVERYMODE_CHANGE_SUCCESS = "cpj_myacc_changeDeliveryMode_success";
export const ADOBE_MYACCOUNT_DELIVERYMODE_CHANGE_SUCCESS = "ADOBE_MYACCOUNT_DELIVERYMODE_CHANGE_SUCCESS";
...
export const SET_DATA_LAYER_RATING_STAR_CLICK = "SET_DATA_LAYER_RATING_STAR_CLICK";
...
export const SET_DATA_LAYER_RATING_MODAL_STAR_CLICK = "SET_DATA_LAYER_RATING_MODAL_STAR_CLICK";

const REVIEW_SUBMIT_CLICK = "review_Submit_Click";
export const SET_DATA_LAYER_REVIEW_SUBMIT_CLICK = "SET_DATA_LAYER_REVIEW_SUBMIT_CLICK";
const REVIEW_CANCEL_CLICk = "review_cancel_Click";
export const SET_DATA_LAYER_REVIEW_CANCEL_CLICK = "SET_DATA_LAYER_REVIEW_CANCEL_CLICK";
const REVIEW_GUIDELINE = "review_guideline";
export const SET_DATA_LAYER_REVIEW_GUIDELINE = "SET_DATA_LAYER_REVIEW_GUIDELINE";
export const SET_DATA_LAYER_VERIFY_BUTTON_UPI = "SET_DATA_LAYER_VERIFY_BUTTON_UPI";
...
const ADOBE_CLICK_ON_EXCHANGE_AVAILABLE_FILTER = "plp_Exchange_Available_Filter";
export const ADOBE_MDE_CLICK_ON_EXCHANGE_AVAILABLE_FILTER = "ADOBE_MDE_CLICK_ON_EXCHANGE_AVAILABLE_FILTER";

const ADOBE_FOR_CLICK_ON_PRODUCT_ON_PLP_MOBILE_EXCHANGE = "plp_With_Exchange_Offer";
const ADOBE_FOR_CLICK_ON_PRODUCT_ON_PLP_WITHOUT_MOBILE_EXCHANGE = "plp_Without_Exchange_Offer";
export const ADOBE_CLICK_ON_PRODUCTS_PLP_WITH_EXCHANGE = "ADOBE_CLICK_ON_PRODUCTS_PLP_WITH_EXCHANGE";
export const ADOBE_CLICK_ON_PRODUCTS_PLP_WITHOUT_EXCHANGE = "ADOBE_CLICK_ON_PRODUCTS_PLP_WITHOUT_EXCHANGE";

const ADOBE_CLICK_ON_EXCHANGE_LINK = "pdp_Exchange_Widget";
export const ADOBE_MDE_CLICK_ON_EXCHANGE_LINK = "ADOBE_MDE_CLICK_ON_EXCHANGE_LINK";

const ADOBE_CLICK_ON_CHANGE_DEVICE = "exchange_Model_Change";
export const ADOBE_MDE_CLICK_ON_CHANGE_DEVICE = "ADOBE_MDE_CLICK_ON_CHANGE_DEVICE";

const ADOBE_CLICK_ON_HOW_EXCHANGE_WORKS = "pdp_How_Exchange_Works";
export const ADOBE_MDE_CLICK_ON_HOW_EXCHANGE_WORKS = "ADOBE_MDE_CLICK_ON_HOW_EXCHANGE_WORKS";
...
export const ADOBE_MDE_PRODUCT_ALREADY_IN_CART = "ADOBE_MDE_PRODUCT_ALREADY_IN_CART";
export const ADOBE_MDE_PRODUCT_ALREADY_IN_CART_GO_TO_BAG = "ADOBE_MDE_PRODUCT_ALREADY_IN_CART_GO_TO_BAG";
export const ADOBE_MDE_PRODUCT_ALREADY_IN_CART_CANCEL = "ADOBE_MDE_PRODUCT_ALREADY_IN_CART_CANCEL";

const ADOBE_CLICK_ON_EXCHANGE_LINK_THROUGH_SELLER = "pdp_Exchange_Through_Seller";
export const ADOBE_MDE_CLICK_ON_EXCHANGE_LINK_THROUGH_SELLER = "ADOBE_MDE_CLICK_ON_EXCHANGE_LINK_THROUGH_SELLER";

const ADOBE_CLICK_ON_EXCHANGE_MODAL_KNOW_MORE = "exchange_Model_Know_More";
export const ADOBE_MDE_CLICK_ON_EXCHANGE_MODAL_KNOW_MORE = "ADOBE_MDE_CLICK_ON_EXCHANGE_MODAL_KNOW_MORE";

const ADOBE_CLICK_ON_EXCHANGE_MODAL_TNC = "exchange_Model_T&c";
export const ADOBE_MDE_CLICK_ON_EXCHANGE_MODAL_TNC = "ADOBE_MDE_CLICK_ON_EXCHANGE_MODAL_TNC";

const ADOBE_CLICK_ON_EXCHANGE_MODAL_ADD_ANOTHER_DEVICE = "exchange_Model_Add_Another_Mobile";
export const ADOBE_MDE_CLICK_ON_EXCHANGE_MODAL_ADD_ANOTHER_DEVICE =
    "ADOBE_MDE_CLICK_ON_EXCHANGE_MODAL_ADD_ANOTHER_DEVICE";

const ADOBE_CLICK_ON_PROCEED_WITH_EXCHANGE = "exchange_Model_Proceed_with_Exchange";
export const ADOBE_MDE_CLICK_ON_PROCEED_WITH_EXCHANGE = "ADOBE_MDE_CLICK_ON_PROCEED_WITH_EXCHANGE";

const ADOBE_CLICK_ON_CASHBACK_DETAILS = "exchange_Model_Cashback_Details";
export const ADOBE_MDE_CLICK_ON_CASHBACK_DETAILS = "ADOBE_MDE_CLICK_ON_CASHBACK_DETAILS";
...
export const ADOBE_MDE_CLICK_ON_REMOVE_EXCHANGE = "ADOBE_MDE_CLICK_ON_REMOVE_EXCHANGE";

const ADOBE_CLICK_ON_GET_NEW_PRICE = "cart_Exchange_Get_New_Price";
export const ADOBE_MDE_CLICK_ON_GET_NEW_PRICE = "ADOBE_MDE_CLICK_ON_GET_NEW_PRICE";

const ADOBE_CLICK_ON_CART_VIEW_MORE = "cart_Exchange_View_More";
export const ADOBE_MDE_CLICK_ON_CART_VIEW_MORE = "ADOBE_MDE_CLICK_ON_CART_VIEW_MORE";

const ADOBE_CLICK_ON_CART_VIEW_LESS = "cart_Exchange_View_Less";
export const ADOBE_MDE_CLICK_ON_CART_VIEW_LESS = "ADOBE_MDE_CLICK_ON_CART_VIEW_LESS";
...
export const ADOBE_MDE_CLICK_ON_SAVE_TO_WISHLIST = "ADOBE_MDE_CLICK_ON_SAVE_TO_WISHLIST";

const ADOBE_CLICK_ON_CHECKOUT_BTN_CART_WITH_EXCHANGE = "cart_Exchange_Checkout";
export const ADOBE_MDE_CLICK_ON_CHECKOUT_BTN_CART_WITH_EXCHANGE = "ADOBE_MDE_CLICK_ON_CHECKOUT_BTN_CART_WITH_EXCHANGE";

const ADOBE_CLICK_ON_CLIQCASH_CHECKOUT_WITH_EXCHANGE = "cart_Exchange_CliqCash";
export const ADOBE_MDE_CLICK_ON_CLIQCASH_CHECKOUT_WITH_EXCHANGE = "ADOBE_MDE_CLICK_ON_CLIQCASH_CHECKOUT_WITH_EXCHANGE";

const ADOBE_CLICK_ON_CANCEL_WITH_EXCHANGE = "OD_Exchange_Cancel";
export const ADOBE_MDE_CLICK_ON_CANCEL_WITH_EXCHANGE = "ADOBE_MDE_CLICK_ON_CANCEL_WITH_EXCHANGE";

const ADOBE_CLICK_ON_RETURN_WITH_EXCHANGE = "OD_Exchange_Returns";
export const ADOBE_MDE_CLICK_ON_RETURN_WITH_EXCHANGE = "ADOBE_MDE_CLICK_ON_RETURN_WITH_EXCHANGE";

const ADOBE_CLICK_ON_CHANGE_ACCOUNT_EXCHANGE = "OC_Change_Account";
export const ADOBE_MDE_CLICK_ON_CHANGE_ACCOUNT_EXCHANGE = "ADOBE_MDE_CLICK_ON_CHANGE_ACCOUNT_EXCHANGE";

const ADOBE_CASHBACK_MODE_CLIQCASH_EXCHANGE = "OC_Cliq_Cash";
export const ADOBE_MDE_CASHBACK_MODE_CLIQCASH_EXCHANGE = "ADOBE_MDE_CASHBACK_MODE_CLIQCASH_EXCHANGE";

const ADOBE_CASHBACK_MODE_BANK_ACCOUNT_EXCHANGE = "OC_Account_Details_CM";
export const ADOBE_MDE_CASHBACK_MODE_BANK_ACCOUNT_EXCHANGE = "ADOBE_MDE_CASHBACK_MODE_BANK_ACCOUNT_EXCHANGE";
const MSD_AUTOMATED_BRAND_PRODUCT_CAROUSAL_ADOBE = "msdAutomatedBannerProductCarouselComponent";

// for product bundling
const ADOBE_ADD_BUNDLED_PRODUCTS_TO_CART_FROM_PDP = "add_both_product_to_cart";
export const ADOBE_PB_ADD_BUNDLED_PRODUCTS_TO_CART_FROM_PDP = "ADOBE_PB_ADD_BUNDLED_PRODUCTS_TO_CART_FROM_PDP";

const ADOBE_ADD_BUNDLED_PRODUCTS_TO_CART_FROM_CART = "add_to_continue_click";
export const ADOBE_PB_ADD_BUNDLED_PRODUCTS_TO_CART_FROM_CART = "ADOBE_PB_ADD_BUNDLED_PRODUCTS_TO_CART_FROM_CART";

const ADOBE_REMOVE_BUNDLED_PRODUCT_FROM_CART = "cpj_cart_removal";
export const ADOBE_PB_REMOVE_BUNDLED_PRODUCT_FROM_CART = "ADOBE_PB_REMOVE_BUNDLED_PRODUCT_FROM_CART";
...
const MDE = "MDE";
export const ADOBE_TRACK_APPLIANCES_EXCHANGE_JOURNEY = "ADOBE_TRACK_APPLIANCES_EXCHANGE_JOURNEY";
export const ADOBE_TRACK_APPLIANCES_EXCHANGE_AC_JOURNEY = "ADOBE_TRACK_APPLIANCES_EXCHANGE_AC_JOURNEY";

export const ADOBE_SELF_SERVE_OTHER_ISSUES_CLICK = "ADOBE_SELF_SERVE_OTHER_ISSUES_CLICK";
export const ADOBE_SELF_SERVE_ALL_HELP_TOPIC_CLICK = "ADOBE_SELF_SERVE_ALL_HELP_TOPIC_CLICK";
export const ADOBE_SELF_SERVE_PAGE_LOAD = "ADOBE_SELF_SERVE_PAGE_LOAD";
export const ADOBE_SELF_SERVE_ISSUE_SELECTION = "ADOBE_SELF_SERVE_ISSUE_SELECTION";
export const ADOBE_SELF_SERVE_FEEDBACK_SELECTION = "ADOBE_SELF_SERVE_FEEDBACK_SELECTION";
export const ADOBE_SELF_SERVE_CONTINUE_BUTTON_CLICK = "ADOBE_SELF_SERVE_CONTINUE_BUTTON_CLICK";
export const ADOBE_SELF_SERVE_MORE_HELP_PAGE_BUTTON_CLICK = "ADOBE_SELF_SERVE_MORE_HELP_PAGE_BUTTON_CLICK";
export const ADOBE_SELF_SERVE_NON_ORDER_CATEGORY_CLICK = "ADOBE_SELF_SERVE_NON_ORDER_CATEGORY_CLICK";
export const ADOBE_SELF_SERVE_SUBMIT_CLICK = "ADOBE_SELF_SERVE_SUBMIT_CLICK";
export const ADOBE_SELF_SERVE_NON_ORDER_QUESTION_CLICK = "ADOBE_SELF_SERVE_NON_ORDER_QUESTION_CLICK";
...
export async function setDataLayer(type, apiResponse, icid, icidType, behaviorOfPage) {
    ...
    if (window.digitalData && window.digitalData.account) {
        localStorage.setItem("loginType", JSON.stringify(window.digitalData.account));
    }
                    ...
                    pageInfo: {
                        pageName:
                            previousData && previousData.page && previousData.page.pageInfo
                                ...
                                : previousData.cpj && previousData.cpj.pdp && previousData.cpj.pdp.findingMethod,
                        pageType:
                            previousData &&
                            previousData.page &&
    ...
    if (type === ADOBE_CART_TYPE) {
        ...
        window.digitalData = Object.assign(window.digitalData, newVariable);
        if (window.digitalData) {
            localStorage.setItem(constants.DIGITAL_DATA_FOR_CART, JSON.stringify(window.digitalData));
        }
        if (window._satellite) {
    ...
    if (type === ADOBE_MY_ACCOUNT_SAVED_LIST) {
        let myAccountDetails = getDigitalDataForMyAccount(MY_ACCOUNT_SAVED_LIST, response);
    ...
    if (type === ADOBE_MY_ACCOUNT_SAVED_PAYMENTS) {
        let myAccountDetails = getDigitalDataForMyAccount(MY_ACCOUNT_SAVED_PAYMENTS);
        window.digitalData = Object.assign(window.digitalData, myAccountDetails);
    }
    ...
    if (type === ADOBE_BLP_PAGE_LOAD) {
        ...
        window.digitalData = Object.assign(window.digitalData, digitalDataForBrandPage);
        if (window._satellite) {
    ...
    if (type === ADOBE_CLP_PAGE_LOAD) {
        ...
        window.digitalData = Object.assign(window.digitalData, digitalDataForCategoryPage);
        if (window._satellite) {
    ...
    if (type === ADOBE_DEFAULT_BLP_PAGE_LOAD || type === ADOBE_DEFAULT_CLP_PAGE_LOAD) {
        let digitalDataForBlpOrClp = getDigitalDataForDefaultBlpOrClp(response);
        window.digitalData = Object.assign(window.digitalData, digitalDataForBlpOrClp);
    }
    ...
    if (type === ADOBE_STATIC_PAGE) {
        ...
        window.digitalData = Object.assign(window.digitalData, digitalDataForStaticData);
    }
    if (type === ADOBE_HELP) {
    ...
    const defaultPinCode = localStorage.getItem(constants.DEFAULT_PIN_CODE_LOCAL_STORAGE);
    ...
    if (type === ADOBE_CLICK_ON_PRODUCTS_PLP_WITH_EXCHANGE) {
        ...
        if (window._satellite) {
            window._satellite.track(ADOBE_FOR_CLICK_ON_PRODUCT_ON_PLP_MOBILE_EXCHANGE);
        }
    }
    if (type === ADOBE_CLICK_ON_PRODUCTS_PLP_WITHOUT_EXCHANGE) {
        window.digitalData.cpj.product = { id: apiResponse };
        if (window._satellite) {
            window._satellite.track(ADOBE_FOR_CLICK_ON_PRODUCT_ON_PLP_WITHOUT_MOBILE_EXCHANGE);
        }
    }
...
export function getDigitalDataForPdp(type, pdpResponse, behaviorOfPage) {
    ...
    let productTag =
        pdpResponse && pdpResponse.allOOStock === true
            ...
            ? "New"
            : pdpResponse.isExchangeAvailable === true && pdpResponse.showExchangeTag === true
            ? "Exchange Offer"
            : pdpResponse && pdpResponse.discount && pdpResponse.discount !== "0"
            ? `${parseInt(pdpResponse.discount, 10)}% off`
            : pdpResponse && pdpResponse.isOfferExisting && pdpResponse.isOfferExisting == "Y"
            ? "On Offer"
            : "";
    ...
    let data = {
        cpj: {
            product: {
                ...
                category_id: productCategoryId && productCategoryId[productCategoryId.length - 1],
    ...
    if (productBreadcrumbs) {
        if (behaviorOfPage === IS_COMING_FOR_REVIEW_PAGE) {
            if (data.page) {
                Object.assign(data.page, {
                    pageInfo: {
                        pageName: "product review:".concat(productBreadcrumbs ? productBreadcrumbs : ""),
                    },
                });
            } else {
                Object.assign(data, {
            ...
            if (data.page) {
                Object.assign(data.page, {
                    pageInfo: {
                        pageName: "product details:".concat(productBreadcrumbs ? productBreadcrumbs : ""),
                        pageType: "PDP",
                    },
                });
            } else {
    ...
    if (pdpResponse && pdpResponse.mrpPrice && pdpResponse.mrpPrice.doubleValue) {
        Object.assign(data.cpj.product, {
            price:
                pdpResponse && pdpResponse.winningSellerPrice && pdpResponse.winningSellerPrice.doubleValue
                    ? pdpResponse.winningSellerPrice.doubleValue
                    : pdpResponse.mrpPrice.doubleValue,
        });
        if (pdpResponse.winningSellerPrice && pdpResponse.winningSellerPrice.doubleValue) {
            Object.assign(data.cpj.product, {
                discount: pdpResponse.mrpPrice.doubleValue - pdpResponse.winningSellerPrice.doubleValue,
            });
        }
    }
    ...
    if (
        ...
        Object.assign(data, {
            cpj: {
                pdp: {
                    findingMethod:
                        window.digitalData && window.digitalData.page && window.digitalData.page.pageInfo.pageName,
                },
            },
        });
    }
...
export function setDataLayerForRetryPaymentAccountSection(cartResponse, retryData) {
    let data = { ...window.digitalData };
    let userDetails = getCookie(constants.LOGGED_IN_USER_DETAILS);
    if (userDetails) {
        userDetails = JSON.parse(userDetails);
    ...
    if (cartResponse && cartResponse.length > 0) {
        ...
        cartResponse.forEach(function(product, index) {
            if (retryData && product.productListingId === retryData[index].productcode) {
                ...
                let originalPrice =
                    product.winningSellerPrice && product.winningSellerPrice.doubleValue
                        ...
                        : null;
                let quantity = totalPrice > originalPrice ? totalPrice / originalPrice : 1;
            ...
            productIdsArray.push(product.productListingId && product.productListingId.toLowerCase());
            productBrandArray.push(product.brandName && product.brandName.replace(/ /g, "_").toLowerCase());
            product && product.rootCategory && categoryArray.push(product.rootCategory);
            if (product.categoryHierarchy && Array.isArray(product.categoryHierarchy)) {
                subCategory1.push(
                    product.categoryHierarchy[0].category_name
                        ? product.categoryHierarchy[0].category_name.replace(/\s+/g, "_").toLowerCase()
                        : null
                );
                subCategory2.push(
                    product.categoryHierarchy[1].category_name
                        ? product.categoryHierarchy[1].category_name.replace(/\s+/g, "_").toLowerCase()
                        : null
                );
                subCategory3.push(
                    product.categoryHierarchy[2].category_name
                        ? product.categoryHierarchy[2].category_name.replace(/\s+/g, "_").toLowerCase()
                        : null
                );
            }
        });
...
function getDigitalDataForOrderConfirmation(type, response) {
    let orderData = localStorage.getItem(constants.DIGITAL_DATA_FOR_PAYMENT_CONFIRMATION);
    ...
    if (getProductData) {
        ...
        productQuantityArray.forEach((element, index) => {
            if (productQuantityArray[index] == null || isNaN(productQuantityArray[index])) {
...
function getProductsDigitalData(response, type) {
    if (response && response.products && response.products.length > 0) {
        ...
        response.products.forEach(function(product) {
            productIdsArray.push(product.productcode && product.productcode.toLowerCase());
            productQuantityArray.push(
                parseInt(
                    product.qtySelectedByUser ? product.qtySelectedByUser : product.quantity ? product.quantity : 1,
                    10
                )
            );
            productPriceArray.push(
...
function getProductCategoryHierarchy(response, setSecondLevel) {
    ...
    if (response && response.products && response.products.length > 0) {
        response.products.forEach(product => {
            if (setSecondLevel) {
                if (product && product.categoryHierarchy && product.categoryHierarchy[1]) {
                    category.push(
                        product.categoryHierarchy[1].category_name
                            ? product.categoryHierarchy[1].category_name.replace(/\s+/g, "_").toLowerCase()
                            : null
                ...
                if (product && product.categoryHierarchy && product.categoryHierarchy[0]) {
                    category.push(
                        product.categoryHierarchy[0].category_name
                            ? product.categoryHierarchy[0].category_name.replace(/\s+/g, "_").toLowerCase()
                            : null
    ...
    if (response && response.products && response.products.length > 0) {
        response.products.forEach(product => {
            ...
            if (product && product.categoryHierarchy && product.categoryHierarchy[1]) {
                subCategory2.push(
                    product.categoryHierarchy[1].category_name
                        ? product.categoryHierarchy[1].category_name.replace(/\s+/, "_").toLowerCase()
                        : null
                );
            }
            if (product && product.categoryHierarchy && product.categoryHierarchy[2]) {
                subCategory3.push(
                    product.categoryHierarchy[2].category_name
                        ? product.categoryHierarchy[2].category_name.replace(/\s+/, "_").toLowerCase()
                        : null
                );
            }
        });
...
function getProductBreadCrumbs(pdpResponse) {
    if (pdpResponse && pdpResponse.seo && pdpResponse.seo.breadcrumbs) {
        const productBreadCrumbs = pdpResponse.seo.breadcrumbs.map(crumbs => {
            return crumbs && crumbs.name && crumbs.name.toLowerCase().replace(/ /g, "_");
        });
...
export async function getMcvId() {
    return new Promise(resolve => {
        let amcvCookieValue = getCookieValue(ADOBE_TARGET_COOKIE_NAME).split(ADOBE_TARGET_SPLIT_VALUE);
        let mcvId = amcvCookieValue[amcvCookieValue.indexOf(ADOBE_TARGET_MCMID) + 1];
        if (mcvId && mcvId.length > 0) {
            resolve(mcvId);
        } else {
            const intervalId = setInterval(() => {
                amcvCookieValue = getCookieValue(ADOBE_TARGET_COOKIE_NAME).split(ADOBE_TARGET_SPLIT_VALUE);
                mcvId = amcvCookieValue[amcvCookieValue.indexOf(ADOBE_TARGET_MCMID) + 1];
                if (mcvId) {
...
export function getDeliveryModeForMyAccountReturn(type) {
...
export function setDataLayerForPdpDirectCalls(type, layerData, response) {
    const previousDigitalData = cloneDeep(window.digitalData);
    if (response) {
        Object.assign(previousDigitalData && previousDigitalData.cpj && previousDigitalData.cpj.product, {
            size: response,
        });
    }
    ...
    if (type === SET_DATA_LAYER_FOR_REVIEW_AND_RATING_EVENT) {
        if (
            ...
            let reviewPage = previousPageName.replace("product details", "product review");
            Object.assign(data, {
                page: {
                    pageInfo: {
                        pageName: reviewPage,
...
export function getDigitalDataForPlp(type, response) {
    ...
    if (subCategories) {
        ...
        Object.assign(data.page, {
            pageInfo: {
                pageName: `product grid:${subCategories.subCategory1 ? subCategories.subCategory1 : ""}:${
...
export function getDigitalDataForSearchPageSuccess(response, type) {
    ...
    const data = {
        ...
        page: {
            ...
            display: {
                hierarchy: `home |${response.currentQuery ? response.currentQuery.searchQuery : null}`,
            },
        },
        internal: {
            search: {
                category: response.currentQuery ? response.currentQuery.searchQuery : "all",
                results:
    ...
    if (response && response.seo && response.seo.alternateURL && CATEGORY_REGEX.test(response.seo.alternateURL)) {
        Object.assign(data.internal.search, {
            category:
                ...
                response.seo.breadcrumbs[0].name
                    ? response.seo.breadcrumbs[0].name
                    : "all",
            results: response && response.pagination && response.pagination.totalResults,
            term:
                response &&
...
export function setDataLayerForPlpDirectCalls(response, index) {
...
export async function setDataLayerForLogin(type, lastLocation) {
    ...
    if (type === ADOBE_DIRECT_CALL_FOR_LOGIN_SUCCESS) {
        ...
        if (data && data.page && data.page.pageInfo && data.page.pageInfo.pageName) {
            Object.assign(window.digitalData, {
                page: {
    ...
    if (type === ADOBE_DIRECT_CALL_FOR_ANONYMOUS_USER) {
        ...
        if (window.digitalData) {
            Object.assign(data, {
                ...
                page: {
                    category: {
                        primaryCategory: data && data.page && data.page.category && data.page.category.primaryCategory,
                    },
                    pageInfo: {
                        pageName: data && data.page && data.page.pageInfo && data.page.pageInfo.pageName,
                        pageType: data && data.page && data.page.pageInfo && data.page.pageInfo.pageType,
                    },
                },
            });
            window.digitalData = data;
...
export function setDataLayerForOrderConfirmationDirectCalls(type, orderConfirmationResponse) {
...
export function setDataLayerForCheckoutDirectCalls(type, response) {
        ...
        Object.assign(data, {
            page: {
                category: {
                    primaryCategory: "multistepcheckoutsummary",
                    subCategory1:
                        cartData && cartData.page && cartData.page.category && cartData.page.category.subCategory1,
                    subCategory2:
                        cartData && cartData.page && cartData.page.category && cartData.page.category.subCategory2,
                    subCategory3:
                        cartData && cartData.page && cartData.page.category && cartData.page.category.subCategory3,
                },
                pageInfo: {
                    pageName: "multi checkout summary page",
                    pageType: "Checkout",
    ...
    if (type === ADOBE_CALL_FOR_APPLY_COUPON_SUCCESS || type === ADOBE_CALL_FOR_APPLY_COUPON_FAILURE) {
        if (data) {
            if (data.cpj) {
                if (data.cpj.coupon) {
    ...
    if (type === ADOBE_FINAL_PAYMENT_MODES) {
        ...
        const cliqCashUsed = localStorage.getItem(constants.CLIQ_CASH_APPLIED_LOCAL_STORAGE);
        if (finalPaymentMode || cliqCashUsed) {
            if (finalPaymentMode && cliqCashUsed) {
                finalPaymentMode = `${finalPaymentMode.replace(/ /g, "_").toLowerCase()}|cliqcash`;
            ...
            localStorage.setItem("digitalDataForPaymentConfirmation", JSON.stringify(data));
        }
        if (window._satellite) {
...
export function setDataLayerForMyAccountDirectCalls(type, productDetails, reasonObj) {
    let data = cloneDeep(window.digitalData);
...
export function getDigitalDataForCLP(response) {
    ...
    if (subCategories) {
        ...
        Object.assign(data.page, {
            pageInfo: {
                pageName: `product grid: ${subCategories.subCategory1 ? subCategories.subCategory1 : null} : ${
...
export function setDataLayerForPinCode(response, type) {
    ...
    if (previousData) {
        ...
        if (previousData.cpj) {
            Object.assign(previousData.cpj, {
                pin: {
                    status: type === ADOBE_DIRECT_CALL_FOR_PINCODE_SUCCESS ? "success" : "failure",
                },
            });
        } else {
            Object.assign(previousData, {
...
export function widgetsTracking(widgetObj) {
    ...
    if (data && data.cpj) {
        Object.assign(data.cpj, {
            widgetName: `${widgetObj.productId ? widgetObj.productId : "x"}:${widgetObj.widgetName}:${
                widgetObj.sourceOfWidget ? widgetObj.sourceOfWidget : ""
            }:${widgetObj.type ? widgetObj.type : "product"}:${widgetObj.brandName ? widgetObj.brandName : "x"}:${
    ...
    if (data && data.cpj) {
        ...
        Object.assign(data.page, {
            widget: {
                name: `${widgetObj.productId ? widgetObj.productId : "x"}:${widgetObj.widgetName}:${
                    widgetObj.sourceOfWidget ? widgetObj.sourceOfWidget : ""
                }:${widgetObj.type ? widgetObj.type : "product"}:${widgetObj.brandName ? widgetObj.brandName : "x"}:${
                    widgetObj.categoryName ? widgetObj.categoryName : "x"
                }:${widgetObj.widgetId ? widgetObj.widgetId : widgetID ? widgetID : "x"}`,
...
export function widgetsTrackingForRecommendation(widgetObject) {
    ...
    Object.assign(window.digitalData, {
        page: {
            ...data.page,
            widget: {
                name: `${widgetObject.productId ? widgetObject.productId : "x"}:${widgetObject.widgetName}:${
...
export function setDataLayerForHeaderAndFooterDirectCalls(type, value) {
    ...
    if (
        ...
        Object.assign(currentDigitalData, {
            page: {
                pageInfo: {
                    pageName: value === "Tata CLiQ Logo" ? "Homepage" : previousDigitalData.page.pageInfo.pageName,
                },
    ...
    if (type === ADOBE_DIRECT_CALL_FOR_CATEGORY_CLICK) {
        ...
        if (currentDigitalData && currentDigitalData.page && currentDigitalData.page.pageInfo) {
...
export function setDataLayerForSelectedFilterDirectCalls(type, filterType, filterValue) {
    const currentDigitalData = window.digitalData;
    Object.assign(currentDigitalData, {
        filter: {
...
export function updatePdpDetailsBackFromReviewPage() {
    ...
    if (
        ...
        let previousPageName = previousDigitalData.page.pageInfo.pageName;
        let reviewPage = previousPageName.replace("product review", "product details");
        Object.assign(currentDigitalData, {
            page: {
                pageInfo: {
                    pageName: reviewPage,
