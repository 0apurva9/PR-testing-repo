...
export default class EmiPanel extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            currentSelectedEMIType: this.props.subEmiOption ? this.props.subEmiOption : "",
  ...
  binValidation = binNo => {
    ...
    getItemBreakUpDetails = (couponCode, noCostEmiText, noCostProductCount, emiInfo) => {
        if (this.props.getItemBreakUpDetails) {
            this.props.getItemBreakUpDetails(couponCode, noCostEmiText, noCostProductCount, emiInfo);
        }
    };
        ...
        if (this.props.isFromRetryUrl) {
            if (
                ...
                if (
                    ...
                    this.props.cart.bankAndTenureDetails.bankList[0].noCostEMICouponList &&
                    this.props.cart.bankAndTenureDetails.bankList[0].noCostEMICouponList[0]
                ) {
                    localStorage.setItem(
                        NO_COST_EMI_COUPON,
                        this.props.cart.bankAndTenureDetails.bankList[0].noCostEMICouponList[0].emicouponName
                    );
                }
            }
        }
    ...
    onChangeEMIType(currentSelectedEMIType, isConfirmPop = false, subMenuSelected) {
    ...
    render() {
        ...
        let paymentMode = this.props.cart && this.props.cart.paymentModes && this.props.cart.paymentModes.paymentModes;
        var instacredMode =
            paymentMode &&
        ...
        if (
            ...
            instacredMiddleLayerISEnable =
                ...
                this.props.cart.instacredMiddleLayerISEnable.applicationProperties[0].value
                    ? this.props.cart.instacredMiddleLayerISEnable.applicationProperties[0].value
                    : false;
        }
        ...
        const dcwPageId = emiEligibiltyDetails && emiEligibiltyDetails.dcwPageId ? emiEligibiltyDetails.dcwPageId : "";
        ...
        let ccEmiText = isCCNoCostEMIEligible ? NO_COST_EMI : isCCEMIEligible ? STANDARD_EMI : "";
        let dcEmiText = isDCNoCostEMIEligible ? NO_COST_EMI : isDCEMIEligible ? STANDARD_EMI : "";
            ...
            <div className={styles.base}>
                ...
                >
                    {(isCCNoCostEMIEligible || isCCEMIEligible) && (
                        <div className={styles.subListHolder}>
                            <NoCostEmi
                                ...
                                onChangeEMIType={(currentSelectedEMIType, isConfirmPop, subMenuSelected) =>
                                    this.onChangeEMIType(currentSelectedEMIType, isConfirmPop, subMenuSelected)
                                }
                                ...
                                emiList={this.props.cart.emiBankDetails && this.props.cart.emiBankDetails.bankList}
                            ...
                            >
                                {isCCNoCostEMIEligible && isCCEMIEligible && (
                                    <div className={styles.tabHeader}>
                                        <div
                                            onClick={() =>
                                                this.onChangeEMIType(NO_COST_EMI, false, this.state.subMenuSelected)
                                            }
                                            className={clsNce}
                                        >
                                            No Cost EMI
                                        ...
                                        <div
                                            onClick={() =>
                                                this.onChangeEMIType(STANDARD_EMI, false, this.state.subMenuSelected)
                                            }
                    ...
                    {instacredMiddleLayerISEnable
                        ? !isRetryPaymentFromURL && (
                              <div className={styles.subListHolder}>
                                  {paymentMode && instacredMode.length > 0 && instacredMode[0].value === true && (
                                      <NoCostEmi
                                          isOpenSubEMI={this.state.currentSelectedEMIType === CARDLESS_EMI}
                                          onChangeEMIType={(currentSelectedEMIType, isConfirmPop, subMenuSelected) =>
...
EmiPanel.propTypes = {
    ...
    isNoCostEmiProceeded: PropTypes.bool,
    onFocusInput: PropTypes.func,
    isNoCostEmiApplied: PropTypes.bool,
    ...
    cart: PropTypes.shape({
        ...
        bankAndTenureDetails: PropTypes.shape({
            numEligibleProducts: PropTypes.number,
            bankList: PropTypes.arrayOf(
                PropTypes.shape({
        ...
        instacredMiddleLayerISEnableStatus: PropTypes.bool,
        paymentModes: PropTypes.shape({
            paymentModes: PropTypes.object,
        }),
        noCostEmiDetails: PropTypes.object,
