...
import { setDataLayer, ADOBE_PB_ADD_BUNDLED_PRODUCTS_TO_CART_FROM_CART } from "../../lib/adobeUtils";
...
export default class DigitalBundledProductSuggestion extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        if (this.props.addBundledProductsToCartDetails !== prevProps.addBundledProductsToCartDetails) {
            ...
            if (this.props.addBundledProductsToCartDetails.status.toLowerCase() === SUCCESS) {
                ...
                setDataLayer(ADOBE_PB_ADD_BUNDLED_PRODUCTS_TO_CART_FROM_CART, this.state.addToCartAnalyticsData);
    ...
    addBundledProductToCart(mainProduct, digitalProduct) {
        ...
        // for analytics
        let productPrice = digitalProduct.winningSellerPrice && digitalProduct.winningSellerPrice.value;
    ...
    render() {
        ...
        let productDescription = trimProductName(this.props.digitalProduct.productDescription, 55);
        return (
            <React.Fragment>
                        ...
                        <div className={styles.digitalBundledProductDetails}>
                            ...
                            <div className={styles.digitalBundledProductImage}>
                                <ProductImage
                                    ...
                                    onClickImage={() =>
                                        this.handleImageClick(this.props.digitalProduct.productListingId)
                                    }
                            ...
                            <div className={styles.digitalProductDetails}>
                                ...
                                <div className={styles.digitalProductDescription}>{productDescription}</div>
                                {this.props.digitalProduct.winningSellerPrice &&
                                    this.props.digitalProduct.winningSellerPrice.formattedValueNoDecimal && (
                            ...
                            <div
                                ...
                                onClick={() =>
                                    this.addBundledProductToCart(this.props.mainProduct, this.props.digitalProduct)
                                }
                            >
                                &#x2B; Add
                            </div>
