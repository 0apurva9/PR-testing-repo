                ...
                >
                    {this.props.productDetails.quantity && (
                        <div className={styles.quantityHolder}>
                            ...
                            <div className={styles.quantityAmount}>{this.props.productDetails.quantity}</div>
                        </div>
                    )}
                    {this.props.productDetails.size && this.props.productDetails.size.toUpperCase() !== NO_SIZE && (
                        <div className={styles.quantityHolder}>
                            <div className={styles.quantityLabel}>Size :</div>
                            <div className={styles.quantityAmount}>{this.props.productDetails.size}</div>
                        </div>
                    )}
                    {this.props.productDetails.productColour && (
                        <div className={styles.quantityHolder}>
                            <div className={styles.quantityLabel}>Color :</div>
                            <div className={styles.quantityAmount}>{this.props.productDetails.productColour}</div>
                        </div>
                    )}
                </OrderCard>
                <PriceAndLink
                    ...
                    <div className={styles.informationDataHolder}>
                        ...
                        {this.props.orderDetails.sellerName && (
                            <div className={styles.orderSoldBy}>
                                ...
                                <div className={styles.infoText}>{this.props.orderDetails.sellerName}</div>
                            </div>
                        )}
                    </div>
                )}
...
OrderDetailsCard.propTypes = {
    ...
    productDetails: PropTypes.shape({
        ...
        imageURL: PropTypes.string,
        imageUrl: PropTypes.string,
        isGiveAway: PropTypes.bool,
        pricevalue: PropTypes.number,
        productName: PropTypes.string,
        quantity: PropTypes.number,
        size: PropTypes.string,
        productColour: PropTypes.string,
    }),
