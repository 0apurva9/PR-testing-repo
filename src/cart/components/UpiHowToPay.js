          ...
          <div className={styles.bottomHolder}>
            <div className={styles.applicationForm}>
              <div className={styles.labelHedaer}>
                ...
                <br />
                <p>
                  Check the collect request from Tata CLiQ in pending
                  transactions in linked UPI app.
                </p>
                <br />
                <p>
                  Complete the payment by accepting the request and entering the
                  UPI pin.
                </p>
                <br />
              </div>
