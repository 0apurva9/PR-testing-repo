...
export default class InvalidCouponPopUp extends React.Component {
    ...
    getInvalidBankOfferTemplate(couponResponse) {
        return `The ${couponResponse.couponCode ? couponResponse.couponCode : ""} is valid for ${this.getBanksList(
    ...
    async continueWithoutCoupon() {
        ...
        if (!bankCouponCode || !userCouponCode || !noCostEmiCoupon) {
            if (
                ...
                releaseStatus = await this.props.releaseBankOffer(this.props.result.bankOffer.couponCode);
            }
            if (
                releaseStatus.status !== SUCCESS &&
                this.props.result &&
            ...
            if (
                ...
                releaseStatus = await this.props.releaseNoCostEmiCoupon(this.props.result.userCoupon.couponCode);
            }
        }
            ...
            <div className={styles.base}>
                ...
                <div className={styles.paymentMethodDescription}>
                    ...
                    <div className={styles.descriptionText}>
                        <div className={styles.invalidCouponHeading}>This payment mode can&apos;t be used because:</div>
                        ...
                        {data &&
                            ...
                            data.noCostEmiCoupon.status.toLowerCase() === FAILURE_LOWERCASE && (
                                <div className={styles.invalidCouponHeading}>
                            ...
                            ((data.noCostEmiCoupon &&
                                ...
                                <div>
                                    ...
                                    {data.noCostEmiCoupon &&
                                        data.noCostEmiCoupon.status &&
                                        data.noCostEmiCoupon.status.toLowerCase() === SUCCESS && (
                                            <div>You may have to select a No Cost EMI plan again.</div>
                                        )}
                                </div>
                            )}
