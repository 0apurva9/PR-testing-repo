...
import { RUPEE_SYMBOL, DEFAULT_PIN_CODE_LOCAL_STORAGE } from "../../lib/constants.js";
export default class Checkout extends React.Component {
    ...
    render() {
        ...
        if (this.props.amount && this.props.amount.toString().includes("₹")) {
            amountWithoutSymbol = this.props.amount && this.props.amount.replace("₹", "");
        } else {
                        ...
                        <div className={styles.amountHolder}>
                            {this.props.isRetryUrl && (
                                <div className={styles.amount}>
                                    {`${RUPEE_SYMBOL} ${this.props.amount ? this.props.amount : ""}`}
                                </div>
                            )}
                            {!this.props.isRetryUrl && (
                                <div className={styles.amount}>{this.props.amount ? this.props.amount : ""}</div>
                            )}
                        </div>
                        <div
