                ...
                >
                    {this.props.isPtm && (
                        <div className={styles.eWalletDetailsHolder}>
                            <div className={styles.paytmLogoHolder} onClick={() => this.handleOnSelect()}>
                        ...
                        <div className={styles.eWalletDetailsHolder}>
                            {this.props.balance && (
                                <div className={styles.currentBalanceHolder}>
                                    <div className={styles.currentBalanceText}>Current wallet balance</div>
                                    <div className={styles.currentBalanceAmount}>{`₹ ${this.props.balance}`}</div>
                                </div>
                            )}
                            <div className={styles.messageTextHolder}>
                                <div className={styles.messageHeader}>You have insufficient balance</div>
