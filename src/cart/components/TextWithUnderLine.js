...
export default class TextWithUnderLine extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={defaultPinCode || this.state.getPinCode ? styles.base : styles.noOffset}>
                <div className={styles.pincodeBox}>
                    {this.props.city ? <div className={styles.cityName}>{this.props.city}, </div> : null}
                ...
                {(defaultPinCode || this.state.getPinCode) && (
                    <React.Fragment>
                        <MobileOnly>
                            ...
                            <div className={styles.defaultClickArea} onClick={() => this.onClick()} />
                        </MobileOnly>
                        <DesktopOnly>
...
TextWithUnderLine.propTypes = {
    ...
    checkPinCodeAvailability: PropTypes.object,
    onFocusInput: PropTypes.func,
    getPinCode: PropTypes.string,
    onBlur: PropTypes.func,
    city: PropTypes.string,
    onKeyPress: PropTypes.func,
    ovalButton: PropTypes.func,
};
