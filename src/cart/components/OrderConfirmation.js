    ...
    async componentDidMount() {
        ...
        if (this.props.orderDetails) {
            this.props.orderDetails.products.map(product => {
                if (product.exchangeDetails && product.exchangeDetails.exchangePaymentDetails) {
                    commonExchangePaymentDetails = product.exchangeDetails.exchangePaymentDetails;
                }
            });
            ...
            if (
                ...
                commonExchangePaymentDetails = this.props.orderDetails.exchangeDetails.exchangePaymentDetails;
            }
        }
        if (commonExchangePaymentDetails) {
            ...
            if (commonExchangePaymentDetails && commonExchangePaymentDetails[0]) {
                data.exchangePaymentMode = commonExchangePaymentDetails[0].exchangePaymentMode;
        ...
        if (cartExchangeDetails) {
            this.props.submitAppliancesExchangeData(this.props.orderId, STATUS_CONFIRMED, false);
        }
    }
                    ...
                    <div className={styles.pageSectionHolder}>
                        <div className={styles.leftSection}>
                            <div className={styles.orderBannerHolder}>
                                {this.props.orderDetails.paymentMethod === "COD" ? (
                                    <PaymentBanner
                                        ...
                                        isGiftCard={this.props.orderDetails && this.props.orderDetails.isEgvOrder}
                                        COD={true}
                                    />
                                ) : (
                                    <OrderBanner
                                        ...
                                        isGiftCard={this.props.orderDetails && this.props.orderDetails.isEgvOrder}
                                        pickUpPersonMobile={
                                            this.props.orderDetails && this.props.orderDetails.pickupPersonMobile
                                        }
                                    />
                                )}
                            </div>
                            ...
                            {!this.props.isComingFromCncToHd &&
                                ...
                                this.props.orderDetails.products.map((order, i) => {
                                    return (
                            ...
                            {this.props.isComingFromCncToHd && (
                                <OrderSucessCard
                                    ...
                                    quantity={"1"}
                                    selectedDeliveryMode={this.props.orderDetails.selectedDeliveryMode}
                            ...
                            {this.state.commonExchangePaymentDetails &&
                                ...
                                this.state.commonExchangePaymentDetails[0].exchangePaymentMode && (
                                        ...
                                        <div className={styles.exchangeCashbackDetails}>
                                            <div className={styles.exchangeCashbackTextContainer}>
                                                ...
                                                "CLIQ_CASH" ? (
                                                    ...
                                                    <span className={styles.exchangeCashbackAccountText}>
                                                        A/c{" "}
                                                        {this.state.commonExchangePaymentDetails[0].accountNumber &&
                        ...
                        <DesktopOnly>
                            <div className={styles.rightSection}>
                                ...
                                <div className={styles.linkHolder}>
                                    ...
                                    <div className={styles.link} onClick={() => this.goToUrl(SAVE_LIST_PAGE)}>
                                    ...
                                    <div className={styles.link} onClick={() => this.goToUrl(MY_ACCOUNT_ADDRESS_PAGE)}>
                                        <div className={styles.icon}>
                                    ...
                                    <div className={styles.link} onClick={() => this.goToUrl(MY_ACCOUNT_ORDERS_PAGE)}>
                                        <div className={styles.icon}>
