        ...
        return (
            <div className={styles.base}>
                <div className={styles.imageHolder}>
                    <ProductImage image={this.props.imageURL} flatImage={this.props.productName === "Gift Card"} />
                </div>
                <div className={styles.dataShowingHolder}>
                    <div className={styles.dataShow}>
                        ...
                        <div className={styles.quantity}>{`Quantity: ${this.props.quantity}`}</div>
                    </div>
                    <div className={styles.deliveryTimingShow}>
                        <div className={styles.timingAndMode}>
                            {estimatedDeliveryDateFormatted && this.props.productName !== "Gift Card" && (
                                <React.Fragment>
                                    <div className={styles.deliveyMode}>{EDD_TEXT}</div>
                                    <div className={styles.deliveryTime}>{estimatedDeliveryDateFormatted}</div>
                                </React.Fragment>
                            )}
                            ...
                            {this.props.exchangeDetails.exchangePriceDetail && (
                                <React.Fragment>
                                    ...
                                    <div className={styles.exchangePickup}>
                                        ...
                                        this.props.exchangeDetails.exchangePriceDetail.pickupCharge.doubleValue ===
                                            0 ? (
...
OrderSucessCard.propTypes = {
    ...
    selectedDeliveryMode: PropTypes.object,
