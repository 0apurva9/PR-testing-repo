            ...
            <div className={styles.base}>
                <div className={styles.productInformation}>
                    <BagPageItem
                        ...
                        ussid={this.props.product.USSID}
                    />
                </div>
                {this.props.deliveryInformation && this.props.deliveryInfoToggle && (
                    <div className={styles.deliveryInfo}>
                        ...
                        <span>
                            ...
                            {this.props.deliverTime && <span>{`: ${this.props.deliverTime}`}</span>}
                        </span>
                    </div>
                )}

                {this.props.isGiveAway === NO && this.state.showDelivery && this.props.deliveryInformation && (
                    <div className={styles.deliveryInfo}>
                        <DeliveryInfoSelect
                ...
                {this.props.isGiveAway === NO && this.props.hasFooter && (
                    <div className={styles.footer}>
                        ...
                        <div className={styles.dropdown}>
                            <div className={styles.dropdownLabel}>{this.props.dropdownLabel}</div>
                            <SelectBoxMobile2
...
CartItem.propTypes = {
    ...
    inCheckOutPage: PropTypes.string,
    selected: PropTypes.bool,
    isClickable: PropTypes.bool,
    deliveryInformationWithDate: PropTypes.string,
