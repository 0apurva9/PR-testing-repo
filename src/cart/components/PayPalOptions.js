...
import eWalletIcon from "./img/paypalLogo.svg";
            ...
            <div className={styles.base}>
                ...
                >
                    <div className={styles.payPalHolder}>
                        <div className={styles.paypalLogoHolder} onClick={() => this.handleOnSelect()}>
                            ...
                            <div className={styles.paypalIcon}>
                                ...
                                <div className={styles.payPalTextHolder}>
                                    <div className={styles.payPalHeading}>The safer and easier way to pay</div>
                                    <div className={styles.payPalSubText}>Note: PayPal accepts all the cards.</div>
                                </div>
                            </div>
                        </div>
                        <DesktopOnly>
...
PayPalOptions.propTypes = {
    ...
    paymentModeSelected: PropTypes.bool,
    selectPayPal: PropTypes.func,
