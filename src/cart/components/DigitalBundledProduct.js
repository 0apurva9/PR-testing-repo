...
import { setDataLayer, ADOBE_PB_REMOVE_BUNDLED_PRODUCT_FROM_CART } from "../../lib/adobeUtils";
...
export default class DigitalBundledProduct extends React.Component {
    handleRemove(entryNumber, mainProductUssid, productcode, categoryHierarchy) {
        ...
        setDataLayer(ADOBE_PB_REMOVE_BUNDLED_PRODUCT_FROM_CART, addToCartAnalyticsData);
    ...
    render() {
        ...
        let productName = trimProductName(this.props.digitalProduct.productName, 40);

        let parsedComboDiscount = this.props.comboDiscount && parseFloat(this.props.comboDiscount);
        ...
        return (
            <React.Fragment>
                <div className={mainContainerClass}>
                    ...
                    <div className={digitalBundledProductImage}>
                        <ProductImage
                            ...
                            onClickImage={() => this.handleImageClick(this.props.digitalProduct.productcode)}
                    ...
                    <div className={digitalProductDetails}>
                        ...
                        {this.props.showPriceSection && this.props.digitalProduct.offerPrice && (
                        ...
                        {this.props.comboDiscount && parsedComboDiscount !== 0 && (
                            <ComboOfferSection
                ...
                {this.props.pageType !== "CANCEL" && this.props.pageType !== "RETURN" && (
                    <React.Fragment>
                        {this.props.digitalProduct.pinCodeResponse &&
                        (this.props.digitalProduct.pinCodeResponse.productOutOfStockMessage ||
                            this.props.digitalProduct.pinCodeResponse.productNotServiceabilityMessage) ? (
...
DigitalBundledProduct.propTypes = {
    ...
    digitalProduct: PropTypes.shape({
        ...
        pinCodeResponse: PropTypes.shape({
    ...
    comboDiscount: PropTypes.string,
    comboDiscountWith: PropTypes.string,
};
