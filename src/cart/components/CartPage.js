...
class CartPage extends React.Component {
    ...
    componentDidMount() {
        ...
        const cartDetailsAnonymous = Cookie.getCookie(
            CART_DETAILS_FOR_ANONYMOUS
        );
                        ...
                        return (
                            ...
                            (product.pinCodeResponse === undefined ||
                                (product.pinCodeResponse &&
                                    product.pinCodeResponse.isServicable ===
                                        "N") ||
        ...
        if (
            ...
            if (cartDetails.products) {
                ...
                if (cartDetails.cartAmount.totalDiscountAmount) {
                    totalDiscount = cartDetails.cartAmount.totalDiscountAmount
                        .value
                        ? Math.round(
                              cartDetails.cartAmount.totalDiscountAmount.value *
                                  100
                          ) / 100
                        : "0.00";
                }
                ...
                if (cartDetails.cartAmount.couponDiscountAmount) {
                    couponDiscount = cartDetails.cartAmount.couponDiscountAmount
                        .value
                        ? Math.round(
                              cartDetails.cartAmount.couponDiscountAmount
                                  .value * 100
                          ) / 100
                        : "0.00";
                }
                            ...
                            <Checkout
                                ...
                                bagTotal={
                                    cartDetails.cartAmount.bagTotal.value
                                        ? Math.round(
                                              cartDetails.cartAmount.bagTotal
                                                  .value * 100
                                          ) / 100
                                        : "0.00"
                                }
