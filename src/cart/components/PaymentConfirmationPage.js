...
import { setDataLayer, ADOBE_MDE_CLICK_ON_CHANGE_ACCOUNT_EXCHANGE } from "../../lib/adobeUtils";
    ...
    async componentDidMount() {
        ...
        if (orderId) {
            ...
            if (cartExchangeDetails) {
                this.props.submitAppliancesExchangeData(orderId, STATUS_CONFIRMED, false);
            }
                                            ...
                                            <div className={styles.gtThnkHed}>
                                                <div className={styles.gtThnkHedInner}>
                                                    ...
                                                    <div className={styles.gtThnkAmtn}>
                                                        <span className={styles.rupeeSymabol}>{RUPEE_SYMBOL} </span>
                                                        {numberFormater}
                                                    </div>
                                                    ...
                                                    {cashback === "enabled" && (
                                                        <div className={styles.cashBackOfferMsgDiv}>
                                                            ...
                                                            <div className={styles.cashBackOfferMsg}>
                                                                Applicable CLiQ CashBack (if any) will be credited to
                                                                your CLiQ Cash account within 24 hours.
                                                            </div>
                                                        </div>
                                                    )}
                                                    <DesktopOnly>
                                        ...
                                        <React.Fragment>
                                            <div className={styles.orderBannerHolder}>
                                                <PaymentBanner
                                                    ...
                                                    isGiftCard={
                                                        this.props.orderDetails && this.props.orderDetails.isEgvOrder
                                                    }
                                                />
                                            </div>
                                            <div className={styles.orderBannerHolder}>
