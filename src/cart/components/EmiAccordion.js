...
import { STANDARD_EMI, EMI_TYPE, EMI_TENURE, SELECTED_BANK_NAME } from "../../lib/constants";
...
export default class EmiAccordion extends React.Component {
    constructor(props) {
        ...
        this.state = {
            planSelected: false,
            selectedEmi: this.props.cardDetails.emi_tenure ? this.props.cardDetails.emi_tenure : "",
            selectedBank: this.props.cardDetails.emi_bank ? this.props.cardDetails.emi_bank : "",
            selectedEmiRate: this.props.cardDetails.selectedEmiRate ? this.props.cardDetails.selectedEmiRate : "",
            selectedPrice: this.props.cardDetails.selectedPrice ? this.props.cardDetails.selectedPrice : "",
            selectedBankName: "",
        };
    }
...
EmiAccordion.propTypes = {
    ...
    cardDetails: PropTypes.arrayOf(
        PropTypes.shape({
            emi_bank: PropTypes.string,
            emi_tenure: PropTypes.number,
        })
    ),
