...
export const PREVENT_REQUESTING_ALL_PAYMENT_MODES = "PREVENT_REQUESTING_ALL_PAYMENT_MODES";
...
export const COLLECT_PAYMENT_ORDER_FOR_GIFTCARD_REQUEST = "COLLECT_PAYMENT_ORDER_FOR_GIFTCARD_REQUEST";
export const COLLECT_PAYMENT_ORDER_FOR_GIFTCARD_SUCCESS = "COLLECT_PAYMENT_ORDER_FOR_GIFTCARD_SUCCESS";
export const COLLECT_PAYMENT_ORDER_FOR_GIFTCARD_FAILURE = "COLLECT_PAYMENT_ORDER_FOR_GIFTCARD_FAILURE";
...
export const GET_PREPAID_ORDER_PAYMENT_CONFIRMATION_FAILURE = "GET_PREPAID_ORDER_PAYMENT_CONFIRMATION_FAILURE";
...
export const ADD_NEW_ADDRESS_FOR_USER_ADDRESS_SUCCESS = "ADD_NEW_ADDRESS_FOR_USER_ADDRESS_SUCCESS";
...
export const GENERATE_CART_ID_FOR_ANONYMOUS_USER_REQUEST = "GENERATE_CART_ID_FOR_ANONYMOUS_USER_REQUEST";
export const GENERATE_CART_ID_FOR_ANONYMOUS_USER_SUCCESS = "GENERATE_CART_ID_FOR_ANONYMOUS_USER_SUCCESS";
export const GENERATE_CART_ID_FOR_ANONYMOUS_USER_FAILURE = "GENERATE_CART_ID_FOR_ANONYMOUS_USER_FAILURE";

export const GENERATE_CART_ID_FOR_LOGGED_IN_USER_REQUEST = "GENERATE_CART_ID_FOR_LOGGED_IN_USER_REQUEST";
export const GENERATE_CART_ID_FOR_LOGGED_IN_USER_SUCCESS = "GENERATE_CART_ID_FOR_LOGGED_IN_USER_SUCCESS";
export const GENERATE_CART_ID_FOR_LOGGED_IN_USER_FAILURE = "GENERATE_CART_ID_FOR_LOGGED_IN_USER_FAILURE";

export const TEMPORARY_CART_ID_FOR_LOGGED_IN_USER_REQUEST = "TEMPORARY_CART_ID_FOR_LOGGED_IN_USER_REQUEST";
export const TEMPORARY_CART_ID_FOR_LOGGED_IN_USER_SUCCESS = "TEMPORARY_CART_ID_FOR_LOGGED_IN_USER_SUCCESS";
export const TEMPORARY_CART_ID_FOR_LOGGED_IN_USER_FAILURE = "TEMPORARY_CART_ID_FOR_LOGGED_IN_USER_FAILURE";
...
export const CHECK_PIN_CODE_SERVICE_AVAILABILITY_REQUEST = "CHECK_PIN_CODE_SERVICE_AVAILABILITY_REQUEST";
export const CHECK_PIN_CODE_SERVICE_AVAILABILITY_SUCCESS = "CHECK_PIN_CODE_SERVICE_AVAILABILITY_SUCCESS";
export const CHECK_PIN_CODE_SERVICE_AVAILABILITY_FAILURE = "CHECK_PIN_CODE_SERVICE_AVAILABILITY_FAILURE";
...
export const UPI_MIDDLE_LAYER_IS_NEW_REQUEST = "UPI_MIDDLE_LAYER_IS_NEW_REQUEST";
export const UPI_MIDDLE_LAYER_IS_NEW_SUCCESS = "UPI_MIDDLE_LAYER_IS_NEW_SUCCESS";
export const UPI_MIDDLE_LAYER_IS_NEW_FAILURE = "UPI_MIDDLE_LAYER_IS_NEW_FAILURE";

export const UPI_MIDDLE_LAYER_HOW_IT_WORKS_REQUEST = "UPI_MIDDLE_LAYER_HOW_IT_WORKS_REQUEST";
export const UPI_MIDDLE_LAYER_HOW_IT_WORKS_SUCCESS = "UPI_MIDDLE_LAYER_HOW_IT_WORKS_SUCCESS";
export const UPI_MIDDLE_LAYER_HOW_IT_WORKS_FAILURE = "UPI_MIDDLE_LAYER_HOW_IT_WORKS_FAILURE";

export const UPI_MIDDLE_LAYER_COMBINED_LOGO_REQUEST = "UPI_MIDDLE_LAYER_COMBINED_LOGO_REQUEST";
export const UPI_MIDDLE_LAYER_COMBINED_LOGO_SUCCESS = "UPI_MIDDLE_LAYER_COMBINED_LOGO_SUCCESS";
export const UPI_MIDDLE_LAYER_COMBINED_LOGO_FAILURE = "UPI_MIDDLE_LAYER_COMBINED_LOGO_FAILURE";

export const UPI_MIDDLE_LAYER_IS_ENABLE_REQUEST = "UPI_MIDDLE_LAYER_IS_ENABLE_REQUEST";
export const UPI_MIDDLE_LAYER_IS_ENABLE_SUCCESS = "UPI_MIDDLE_LAYER_IS_ENABLE_SUCCESS";
export const UPI_MIDDLE_LAYER_IS_ENABLE_FAILURE = "UPI_MIDDLE_LAYER_IS_ENABLE_FAILURE";

export const INSTACRED_MIDDLE_LAYER_IS_ENABLE_REQUEST = "INSTACRED_MIDDLE_LAYER_IS_ENABLE_REQUEST";
export const INSTACRED_MIDDLE_LAYER_IS_ENABLE_SUCCESS = "INSTACRED_MIDDLE_LAYER_IS_ENABLE_SUCCESS";
export const INSTACRED_MIDDLE_LAYER_IS_ENABLE_FAILURE = "INSTACRED_MIDDLE_LAYER_IS_ENABLE_FAILURE";

export const COLLECT_PAYMENT_ORDER_FOR_UPI_REQUEST = "COLLECT_PAYMENT_ORDER_FOR_UPI_REQUEST";
export const COLLECT_PAYMENT_ORDER_FOR_UPI_SUCCESS = "COLLECT_PAYMENT_ORDER_FOR_UPI_SUCCESS";
export const COLLECT_PAYMENT_ORDER_FOR_UPI_FAILURE = "COLLECT_PAYMENT_ORDER_FOR_UPI_FAILURE";
...
export const RELEASE_BANK_OFFER_UPDATE_SUCCESS = "RELEASE_BANK_OFFER_UPDATE_SUCCESS";
...
export const SOFT_RESERVATION_FOR_PAYMENT_REQUEST = "SOFT_RESERVATION_FOR_PAYMENT_REQUEST";
export const SOFT_RESERVATION_FOR_PAYMENT_SUCCESS = "SOFT_RESERVATION_FOR_PAYMENT_SUCCESS";
export const SOFT_RESERVATION_FOR_PAYMENT_FAILURE = "SOFT_RESERVATION_FOR_PAYMENT_FAILURE";
...
export const CREATE_JUS_PAY_ORDER_FOR_CLIQ_CASH_SUCCESS = "CREATE_JUS_PAY_ORDER_FOR_CLIQ_CASH_SUCCESS";
export const CREATE_JUS_PAY_ORDER_FAILURE = "CREATE_JUS_PAY_ORDER_FAILURE";

export const JUS_PAY_PAYMENT_METHOD_TYPE_REQUEST = "JUS_PAY_PAYMENT_METHOD_TYPE_REQUEST";
export const JUS_PAY_PAYMENT_METHOD_TYPE_SUCCESS = "JUS_PAY_PAYMENT_METHOD_TYPE_SUCCESS";
export const JUS_PAY_PAYMENT_METHOD_TYPE_FOR_GIFT_CARD_SUCCESS = "JUS_PAY_PAYMENT_METHOD_TYPE_FOR_GIFT_CARD_SUCCESS";
export const JUS_PAY_PAYMENT_METHOD_TYPE_FAILURE = "JUS_PAY_PAYMENT_METHOD_TYPE_FAILURE";

export const UPDATE_TRANSACTION_DETAILS_REQUEST = "UPDATE_TRANSACTION_DETAILS_REQUEST";
export const UPDATE_TRANSACTION_DETAILS_SUCCESS = "UPDATE_TRANSACTION_DETAILS_SUCCESS";
export const UPDATE_TRANSACTION_DETAILS_FAILURE = "UPDATE_TRANSACTION_DETAILS_FAILURE";
...
export const UPDATE_TRANSACTION_DETAILS_FOR_COD_REQUEST = "UPDATE_TRANSACTION_DETAILS_FOR_COD_REQUEST";
export const UPDATE_TRANSACTION_DETAILS_FOR_COD_SUCCESS = "UPDATE_TRANSACTION_DETAILS_FOR_COD_SUCCESS";
export const UPDATE_TRANSACTION_DETAILS_FOR_COD_FAILURE = "UPDATE_TRANSACTION_DETAILS_FOR_COD_FAILURE";

export const SOFT_RESERVATION_FOR_COD_PAYMENT_REQUEST = "SOFT_RESERVATION_FOR_COD_PAYMENT_REQUEST";
export const SOFT_RESERVATION_FOR_COD_PAYMENT_SUCCESS = "SOFT_RESERVATION_FOR_COD_PAYMENT_SUCCESS";
export const SOFT_RESERVATION_FOR_COD_PAYMENT_FAILURE = "SOFT_RESERVATION_FOR_COD_PAYMENT_FAILURE";

export const ORDER_EXPERIENCE_CAPTURE_REQUEST = "ORDER_EXPERIENCE_CAPTURE_REQUEST";
export const ORDER_EXPERIENCE_CAPTURE_SUCCESS = "ORDER_EXPERIENCE_CAPTURE_SUCCESS";
export const ORDER_EXPERIENCE_CAPTURE_FAILURE = "ORDER_EXPERIENCE_CAPTURE_FAILURE";

export const CLEAR_ORDER_EXPERIENCE_CAPTURE = "CLEAR_ORDER_EXPERIENCE_CAPTURE";

export const ADD_PRODUCT_TO_WISH_LIST_REQUEST = "ADD_PRODUCT_TO_WISH_LIST_REQUEST";
export const ADD_PRODUCT_TO_WISH_LIST_SUCCESS = "ADD_PRODUCT_TO_WISH_LIST_SUCCESS";
export const ADD_PRODUCT_TO_WISH_LIST_FAILURE = "ADD_PRODUCT_TO_WISH_LIST_FAILURE";
export const REMOVE_ITEM_FROM_CART_LOGGED_IN_REQUEST = "REMOVE_ITEM_FROM_CART_LOGGED_IN_REQUEST";
export const REMOVE_ITEM_FROM_CART_LOGGED_IN_SUCCESS = "REMOVE_ITEM_FROM_CART_LOGGED_IN_SUCCESS";
export const REMOVE_ITEM_FROM_CART_LOGGED_IN_FAILURE = "REMOVE_ITEM_FROM_CART_LOGGED_IN_FAILURE";

export const REMOVE_ITEM_FROM_CART_LOGGED_OUT_REQUEST = "REMOVE_ITEM_FROM_CART_LOGGED_OUT_REQUEST";
export const REMOVE_ITEM_FROM_CART_LOGGED_OUT_SUCCESS = "REMOVE_ITEM_FROM_CART_LOGGED_OUT_SUCCESS";
export const REMOVE_ITEM_FROM_CART_LOGGED_OUT_FAILURE = "REMOVE_ITEM_FROM_CART_LOGGED_OUT_FAILURE";

export const UPDATE_QUANTITY_IN_CART_LOGGED_IN_REQUEST = "UPDATE_QUANTITY_IN_CART_LOGGED_IN_REQUEST";
export const UPDATE_QUANTITY_IN_CART_LOGGED_IN_SUCCESS = "UPDATE_QUANTITY_IN_CART_LOGGED_IN_SUCCESS";
export const UPDATE_QUANTITY_IN_CART_LOGGED_IN_FAILURE = "UPDATE_QUANTITY_IN_CART_LOGGED_IN_FAILURE";

export const UPDATE_QUANTITY_IN_CART_LOGGED_OUT_REQUEST = "UPDATE_QUANTITY_IN_CART_LOGGED_OUT_REQUEST";
export const UPDATE_QUANTITY_IN_CART_LOGGED_OUT_SUCCESS = "UPDATE_QUANTITY_IN_CART_LOGGED_OUT_SUCCESS";
export const UPDATE_QUANTITY_IN_CART_LOGGED_OUT_FAILURE = "UPDATE_QUANTITY_IN_CART_LOGGED_OUT_FAILURE";
...
export const PAYMENT_FAILURE_ORDER_DETAILS_REQUEST = "PAYMENT_FAILURE_ORDER_DETAILS_REQUEST";
export const PAYMENT_FAILURE_ORDER_DETAILS_SUCCESS = "PAYMENT_FAILURE_ORDER_DETAILS_SUCCESS";
export const PAYMENT_FAILURE_ORDER_DETAILS_FAILURE = "PAYMENT_FAILURE_ORDER_DETAILS_FAILURE";
export const RESET_IS_SOFT_RESERVATION_FAILED = "RESET_IS_SOFT_RESERVATION_FAILED";

export const MERGE_TEMP_CART_WITH_OLD_CART_REQUEST = "MERGE_TEMP_CART_WITH_OLD_CART_REQUEST";
export const MERGE_TEMP_CART_WITH_OLD_CART_SUCCESS = "MERGE_TEMP_CART_WITH_OLD_CART_SUCCESS";
export const MERGE_TEMP_CART_WITH_OLD_CART_FAILURE = "MERGE_TEMP_CART_WITH_OLD_CART_FAILURE";
...
export const BIN_VALIDATION_OF_EMI_ELIGIBLE_REQUEST = "BIN_VALIDATION_OF_EMI_ELIGIBLE_REQUEST";
export const BIN_VALIDATION_OF_EMI_ELIGIBLE_FAILURE = "BIN_VALIDATION_OF_EMI_ELIGIBLE_FAILURE";
export const BIN_VALIDATION_OF_EMI_ELIGIBLE_SUCCESS = "BIN_VALIDATION_OF_EMI_ELIGIBLE_SUCCESS";

export const GET_CART_COUNT_FOR_LOGGED_IN_USER_SUCCESS = "GET_CART_COUNT_FOR_LOGGED_IN_USER_SUCCESS";
export const GET_CART_COUNT_FOR_LOGGED_IN_USER_REQUEST = "GET_CART_COUNT_FOR_LOGGED_IN_USER_REQUEST";
export const GET_CART_COUNT_FOR_LOGGED_IN_USER_FAILURE = "GET_CART_COUNT_FOR_LOGGED_IN_USER_FAILURE";

export const GET_ORDER_UPDATE_ON_WHATSAPP_REQUEST = "GET_ORDER_UPDATE_ON_WHATSAPP_REQUEST";
export const GET_ORDER_UPDATE_ON_WHATSAPP_SUCCESS = "GET_ORDER_UPDATE_ON_WHATSAPP_SUCCESS";
export const GET_ORDER_UPDATE_ON_WHATSAPP_FAILURE = "GET_ORDER_UPDATE_ON_WHATSAPP_FAILURE";
...
export const ORDER_CONFIRMATION_BANNER_REQUEST = "ORDER_CONFIRMATION_BANNER_REQUEST";
export const ORDER_CONFIRMATION_BANNER_SUCCESS = "ORDER_CONFIRMATION_BANNER_SUCCESS";
export const ORDER_CONFIRMATION_BANNER_FAILURE = "ORDER_CONFIRMATION_BANNER_FAILURE";
export const UPI_VPA = "upi_vpa";

export const GET_INTERMITTENT_FEEDBACK_DATA_REQUEST = "GET_INTERMITTENT_FEEDBACK_DATA_REQUEST";
export const GET_INTERMITTENT_FEEDBACK_DATA_SUCCESS = "GET_INTERMITTENT_FEEDBACK_DATA_SUCCESS";
export const GET_INTERMITTENT_FEEDBACK_DATA_FAILURE = "GET_INTERMITTENT_FEEDBACK_DATA_FAILURE";
...
export const SUBMIT_APPLIANCES_EXCHANGE_DATA_REQUEST = "SUBMIT_APPLIANCES_EXCHANGE_DATA_REQUEST";
export const SUBMIT_APPLIANCES_EXCHANGE_DATA_SUCCESS = "SUBMIT_APPLIANCES_EXCHANGE_DATA_SUCCESS";
export const SUBMIT_APPLIANCES_EXCHANGE_DATA_FAILURE = "SUBMIT_APPLIANCES_EXCHANGE_DATA_FAILURE";

export const MDE_FRAUD_CHECK_REQUEST = "MDE_FRAUD_CHECK_REQUEST";
...
export function getCartDetails(userId, accessToken, cartId, pinCode, isSetDataLayer) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            if (resultJson && resultJson.products) {
                let productExchangeNonServiceable = resultJson.products.find(value => {
                    if (value.exchangeDetails && !value.pinCodeResponse.isPickupAvailableForExchange) {
                        return value.pinCodeResponse.errorMessagePincode;
                    }
                });
                if (productExchangeNonServiceable && productExchangeNonServiceable.pinCodeResponse) {
                    dispatch(displayToast(productExchangeNonServiceable.pinCodeResponse.errorMessagePincode));
                }
            }
            ...
            if (isSetDataLayer) {
                setDataLayer(ADOBE_CHECKOUT_TYPE, resultJson, getState().icid.value, getState().icid.icidType);
            }
...
export function applyUserCouponForAnonymous(couponCode) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            if (resultJsonStatus.status) {
                setDataLayerForCartDirectCalls(ADOBE_CALLS_FOR_APPLY_COUPON_FAIL, couponCode);
                throw new Error(resultJsonStatus.message);
            }
            setDataLayerForCartDirectCalls(ADOBE_CALLS_FOR_APPLY_COUPON_SUCCESS, couponCode);
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/carts/${cartId}/releaseCoupons?access_token=${
                    JSON.parse(customerCookie).access_token
...
export function getUserAddress(setDataLayerForMyAccount = false) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.get(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/addresses?channel=${CHANNEL}&emailId=${
...
export function addUserAddressRequest() {
    return {
...
export function addNewAddressForUserSuccess() {
    return {
...
export function addUserAddress(userAddress) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.postFormData(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/addAddress?access_token=${
                    JSON.parse(customerCookie).access_token
...
export function selectDeliveryMode(deliveryUssId) {
    let customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
    let cartDetails = Cookie.getCookie(CART_DETAILS_FOR_LOGGED_IN_USER);
    let userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            setDataLayerForCheckoutDirectCalls(ADOBE_CALL_FOR_PROCCEED_FROM_DELIVERY_MODE);
        } catch (e) {
...
export function addAddressToCartRequest() {
    return {
...
export function addAddressToCart(addressId, pinCode, isComingFromCliqAndPiq, isExchangeProductInCart) {
    let newPinCode;
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            dispatch(getCartDetailsCNC(userId, access_token, cartId, newPinCode, false));
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.get(
                `${USER_CART_PATH}/${
                    JSON.parse(userDetails).userName
                }/netbankingDetails?channel=${CHANNEL}&access_token=${JSON.parse(customerCookie).access_token}`
            );
            const resultJson = await result.json();
            const resultJsonStatus = ErrorHandling.getFailureResponse(resultJson);
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/carts?access_token=${
                    JSON.parse(customerCookie).access_token
                }&isPwa=true&platformNumber=${PLAT_FORM_NUMBER}&userId=${JSON.parse(userDetails).userName}&oldCartId=${
                    JSON.parse(cartDetailsAnonymous).guid
                }${cartGuId ? "&toMergeCartGuid=" + cartGuId : ""}&channel=${CHANNEL}&isMDE=true`
            );
            const resultJson = await result.json();
            const currentBagObject = localStorage.getItem(CART_BAG_DETAILS);
            const currentBagCount = currentBagObject ? JSON.parse(currentBagObject).length : 0;
            const updatedBagCount = parseInt(resultJson.count, 10);
            if (getState().auth.redirectToAfterAuthUrl === PRODUCT_CART_ROUTER) {
                const isAddToWishlist = localStorage.getItem(PRODUCT_DETAIL_FOR_ADD_TO_WISHLIST);
...
export function checkPinCodeServiceAvailability(userName, accessToken, pinCode, productCode) {
...
export function getAllStoresCNC(pinCode) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.get(`${ALL_STORES_PATH}/${pinCode}?access_token=${accessToken}&isMDE=true`);
            const resultJson = await result.json();
            const resultJsonStatus = ErrorHandling.getFailureResponse(resultJson);
...
export function addPickupPersonCNC(personMobile, personName) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/carts/${cartId}/addPickupPerson?access_token=${
                    JSON.parse(customerCookie).access_token
...
export function softReservation() {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        let productItems = await getValidDeliveryModeDetails(
            getState().cart && getState().cart.cartDetailsCNC && getState().cart.cartDetailsCNC.products
        );
        if (productItems) {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/carts/${cartId}/softReservation?access_token=${
                    JSON.parse(customerCookie).access_token
...
export function getPaymentModes(guId) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/payments/getPaymentModes?access_token=${
                    JSON.parse(customerCookie).access_token
            ...
            setDataLayerForCheckoutDirectCalls(ADOBE_CALL_FOR_LANDING_ON_PAYMENT_MODE);
        } catch (e) {
...
export function upiPaymentCombinedLogoMidddleLayerSuccess(upiPaymentCombinedLogoMidddleLayerDetails) {
    return {
...
export function upiPaymentCombinedLogoMidddleLayer() {
    return async (dispatch, getState, { api }) => {
...
export function upiPaymentHowItWorksMidddleLayerSuccess(upiPaymentHowItWorksMidddleLayerDetails) {
    return {
...
export function upiPaymentHowItWorksMidddleLayer() {
    return async (dispatch, getState, { api }) => {
...
export function upiPaymentIsNewMidddleLayerSuccess(upiPaymentIsNewMidddleLayerDetails) {
    return {
...
export function upiPaymentIsNewMidddleLayer() {
    return async (dispatch, getState, { api }) => {
...
export function upiPaymentISEnableMidddleLayerSuccess(upiPaymentISEnableMidddleLayerDetails) {
    return {
...
export function upiPaymentISEnableMidddleLayer() {
    return async (dispatch, getState, { api }) => {
...
export function instaCredISEnableMidddleLayerSuccess(instaCredISEnableMidddleLayerDetails) {
    return {
...
export function binValidationForUPI(paymentMode, isFromRetryUrl, retryCartGuid) {
...
export function collectPaymentOrderForGiftCardUPI(egvCartGuid, bankCode, bankName) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            dispatch(jusPayPaymentMethodTypeForGiftCardUPI(resultJson.pspAuditId, upi_vpa, egvCartGuid));
        } catch (e) {
...
export function softReservationPaymentForUPI(paymentMethodType, paymentMode, bankCode, pinCode, bankName) {
    let userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    let customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
    return async (dispatch, getState, { api }) => {
        let productItems = "";
        ...
        productItems = await getValidDeliveryModeDetails(getState().cart.cartDetailsCNC.products);
        if (productItems) {
            localStorage.setItem(CART_ITEM_COOKIE, JSON.stringify(productItems));
        }
        cartDetails = Cookie.getCookie(CART_DETAILS_FOR_LOGGED_IN_USER);
...
export function jusPayPaymentMethodTypeForGiftCardUPI(juspayOrderId, upi_vpa, guId) {
    return async (dispatch, getState, { api }) => {
        const params = {
            payment_method_type: "UPI",
            redirect_after_payment: "true",
...
export function createJusPayOrderForUPI(cardDetails, cartItemObj, isPaymentFailed, isFromRetryUrl, retryCartGuid) {
    let browserName = browserAndDeviceDetails.getBrowserAndDeviceDetails(1);
    let fullVersion = browserAndDeviceDetails.getBrowserAndDeviceDetails(2);
    let deviceInfo = browserAndDeviceDetails.getBrowserAndDeviceDetails(3);
    let networkType = browserAndDeviceDetails.getBrowserAndDeviceDetails(4);
...
export function applyBankOffer(couponCode) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/carts/applyBankCoupons?access_token=${
                    JSON.parse(customerCookie).access_token
            ...
            if (resultJsonStatus.status) {
                setDataLayerForCheckoutDirectCalls(ADOBE_CALL_FOR_APPLY_COUPON_FAILURE, couponCode);
                ...
                } else if (resultJson.errorCode === ERROR_CODE_FOR_BANK_OFFER_INVALID_4) {
                    dispatch(displayToast(resultJson.couponMessage));
                    localStorage.removeItem(BANK_COUPON_COOKIE);
                } else if (resultJson.errorCode === ERROR_CODE_FOR_BANK_OFFER_INVALID_5) {
                    dispatch(displayToast(resultJson.error));
                    localStorage.removeItem(BANK_COUPON_COOKIE);
                } else if (resultJson.errorCode === ERROR_CODE_FOR_BANK_OFFER_INVALID_6) {
                    dispatch(displayToast(resultJson.error));
                    localStorage.removeItem(BANK_COUPON_COOKIE);
                } else {
                    localStorage.removeItem(BANK_COUPON_COOKIE);
                ...
                setDataLayerForCheckoutDirectCalls(ADOBE_CALL_FOR_APPLY_COUPON_SUCCESS, couponCode);
            }
...
export function releaseBankOffer(previousCouponCode, newCouponCode = null) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/carts/releaseCartCoupons?access_token=${
                    JSON.parse(customerCookie).access_token
            ...
            if (!getState().cart.cartDetailsCNC && getState().profile.retryPaymentDetails) {
...
export function applyCliqCash() {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/applyCliqCash?access_token=${
                    JSON.parse(customerCookie).access_token
...
export function removeCliqCash() {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/removeCliqCash?access_token=${
                    JSON.parse(customerCookie).access_token
                }&cartGuid=${cartId}&isPwa=true&isUpdatedPwa=true`
            );
            const resultJson = await result.json();
...
// Action Creator to bin Validation
export function binValidation(paymentMode, binNo, isFromRetryUrl, retryCartGuid) {
    let userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    let customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            let cardType = resultJson.cardType && resultJson.cardType.replace(/\s/g, "");
            if (cardType) {
...
export function binValidationForNetBanking(paymentMode, bankName, isFromRetryUrl, retryCartGuid) {
    let userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    let customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
    let cartDetails = Cookie.getCookie(CART_DETAILS_FOR_LOGGED_IN_USER);
    let egvCartGuid = Cookie.getCookie("egvCartGuid");
...
export function softReservationForPayment(cardDetails, address) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            dispatch(stripe_juspay_Tokenize(cardDetails, address, productItems, paymentMode, false));
        } catch (e) {
            dispatch(softReservationForPaymentFailure(e.message));
        }
    };
...
export function softReservationPaymentForNetBanking(paymentMethodType, paymentMode, bankCode, pinCode, bankName) {
    let userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    let customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
    return async (dispatch, getState, { api }) => {
        let productItems = await getValidDeliveryModeDetails(getState().cart.cartDetailsCNC.products);
...
export function softReservationPaymentForSavedCard(cardDetails) {
    let userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    let customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
    return async (dispatch, getState, { api }) => {
        let productItems = await getValidDeliveryModeDetails(getState().cart.cartDetailsCNC.products);
...
export function jusPayTokenize(cardDetails) {
    return async (dispatch, getState, { api }) => {
        ...
        cardObject.append("card_security_code", cardDetails && cardDetails.cvvNumber);
...
export function jusPayTokenizeForGiftCard(cardDetails) {
    return async (dispatch, getState, { api }) => {
        let cardObject = new FormData();
...
export function createJusPayOrder(
    ...
    let emiTenure = selectedEmiTenure ? selectedEmiTenure : cardDetails.emi_tenure;
    return async (dispatch, getState, { api }) => {
        let productItems = "";
        if (isFromRetryUrl) {
            productItems = getValidDeliveryModeDetails(
        ...
        try {
            ...
            if (isFromRetryUrl) {
                result = await api.post(
                    `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/createJuspayOrder?access_token=${
                        JSON.parse(customerCookie).access_token
                    }&firstName=${address.firstName}&lastName=${address.lastName}&addressLine1=${
                        address.line1 ? encodeURIComponent(address.line1) : ""
                    }&addressLine2=${address.line2 ? address.line2 : ""}&addressLine3=${
                        address.line3 ? address.line3 : ""
                    }&country=${address.country.isocode}&city=${address.city ? address.city : ""}&state=${
            ...
            dispatch(jusPayPaymentMethodType(resultJson.juspayOrderId, cardDetails, paymentMode));
        } catch (e) {
            dispatch(createJusPayOrderFailure(e.message));
        }
    };
...
export function createJusPayOrderForGiftCard(token, cardDetails, paymentMode, guId) {
    let browserName = browserAndDeviceDetails.getBrowserAndDeviceDetails(1);
    let fullVersion = browserAndDeviceDetails.getBrowserAndDeviceDetails(2);
    let deviceInfo = browserAndDeviceDetails.getBrowserAndDeviceDetails(3);
    let networkType = browserAndDeviceDetails.getBrowserAndDeviceDetails(4);
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/createJuspayOrder?access_token=${
                    ...
                    bankName ? bankName : ""
                }&channel=${CHANNEL}&isUpdatedPwa=true${whatsappNotification ? "&whatsapp=true" : ""}`
            );
            const resultJson = await result.json();
            const resultJsonStatus = ErrorHandling.getFailureResponse(resultJson);
            ...
            dispatch(jusPayPaymentMethodTypeForGiftCard(resultJson.juspayOrderId, cardDetails, paymentMode, guId));
        } catch (e) {
            dispatch(createJusPayOrderFailure(e.message));
        }
    };
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            if (localStorage.getItem(PAYMENT_MODE_TYPE) === PAYPAL) {
                dispatch(jusPayPaymentMethodTypeForPaypal(paymentMethodType, resultJson.juspayOrderId, bankCode));
            } else {
                dispatch(jusPayPaymentMethodTypeForNetBanking(paymentMethodType, resultJson.juspayOrderId, bankCode));
            }
        } catch (e) {
            dispatch(createJusPayOrderFailure(e.message));
        }
...
export function createJusPayOrderForGiftCardNetBanking(guId, bankCode, bankName) {
    const jusPayUrl = `${window.location.origin}/checkout/payment-method/cardPayment`;
    let userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    let customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
    const currentSelectedPaymentMode = localStorage.getItem(PAYMENT_MODE_TYPE);
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            dispatch(jusPayPaymentMethodTypeForGiftCardNetBanking(resultJson.juspayOrderId, bankCode, guId));
        } catch (e) {
            dispatch(createJusPayOrderFailure(e.message));
        }
    };
...
export function createJusPayOrderForSavedCards(
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            dispatch(jusPayPaymentMethodTypeForSavedCards(resultJson.juspayOrderId, cardDetails));
        } catch (e) {
            dispatch(createJusPayOrderFailure(e.message));
        }
    };
...
export function createJusPayOrderForGiftCardFromSavedCards(cardDetails, guId) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            dispatch(jusPayPaymentMethodTypeForGiftCardFromSavedCards(resultJson.juspayOrderId, cardDetails, guId));
        } catch (e) {
            dispatch(createJusPayOrderFailure(e.message));
        }
    };
...
export function createJusPayOrderForCliqCash(pinCode, cartItemObj, isPaymentFailed = false) {
    let cartItem;
    let browserName = browserAndDeviceDetails.getBrowserAndDeviceDetails(1);
    let fullVersion = browserAndDeviceDetails.getBrowserAndDeviceDetails(2);
    let deviceInfo = browserAndDeviceDetails.getBrowserAndDeviceDetails(3);
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            dispatch(setBagCount(0));
            localStorage.setItem(ORDER_ID_FOR_ORDER_CONFIRMATION_PAGE, resultJson.orderId);
            localStorage.setItem(CART_BAG_DETAILS, []);
...
export function jusPayPaymentMethodTypeForGiftCardSuccess(justPayPaymentDetails, guId) {
    // Here we need to dispatch an action to cre
    return {
...
export function jusPayPaymentMethodTypeFailure() {
    return {
...
export function jusPayPaymentMethodTypeForGiftCard(juspayOrderId, cardDetails, paymentMode, guId) {
    return async (dispatch, getState, { api }) => {
        dispatch(jusPayPaymentMethodTypeRequest());
        try {
            let cardObject = new FormData();
            ...
            if (
                cardDetails.is_emi &&
                (localStorage.getItem(NO_COST_EMI_COUPON) || localStorage.getItem(EMI_TYPE) === STANDARD_EMI)
            ) {
...
export function jusPayPaymentMethodType(juspayOrderId, cardDetails) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            if (
                cardDetails.is_emi &&
                (cardDetails.selectedCouponCode || localStorage.getItem(EMI_TYPE) === STANDARD_EMI)
            ) {
                cardObject.append("emi_bank", cardDetails.emi_bank);
                cardObject.append("emi_tenure", cardDetails.emi_tenure);
                cardObject.append("is_emi", cardDetails.is_emi);
...
export function jusPayPaymentMethodTypeForSavedCards(juspayOrderId, cardDetails) {
    return async (dispatch, getState, { api }) => {
        dispatch(jusPayPaymentMethodTypeRequest());
        let cardObject = new FormData();
        cardObject.append("payment_method_type", "CARD");
...
export function jusPayPaymentMethodTypeForGiftCardFromSavedCards(juspayOrderId, cardDetails, guId) {
    return async (dispatch, getState, { api }) => {
        let cardObject = new FormData();
        cardObject.append("payment_method_type", "CARD");
        cardObject.append("redirect_after_payment", "true");
...
export function jusPayPaymentMethodTypeForNetBanking(paymentMethodType, juspayOrderId, bankName) {
    return async (dispatch, getState, { api }) => {
        let cardObject = new FormData();
...
export function jusPayPaymentMethodTypeForPaypal(paymentMethodType, juspayOrderId) {
    return async (dispatch, getState, { api }) => {
        const params = {
...
export function jusPayPaymentMethodTypeForInstaCred(paymentMethodType, juspayOrderId) {
...
export function jusPayPaymentMethodTypeForGiftCardNetBanking(juspayOrderId, bankName, guId) {
    return async (dispatch, getState, { api }) => {
        let cardObject = new FormData();
...
export function updateTransactionDetails(paymentMode, juspayOrderID, cartId) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            const resultJsonStatus = ErrorHandling.getFailureResponse(resultJson);
            if (resultJsonStatus.status) {
                setDataLayerForOrderConfirmationDirectCalls(ADOBE_DIRECT_CALLS_FOR_ORDER_CONFIRMATION_FAILURE, {
...
export function orderConfirmation(orderId) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.get(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/orderConfirmation/${orderId}?access_token=${
                    JSON.parse(customerCookie).access_token
            ...
            setDataLayer(ADOBE_ORDER_CONFIRMATION, resultJson, getState().icid.value, getState().icid.icidType);
...
export function captureOrderExperience(orderId, rating) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/orderExperience/${orderId}?access_token=${
                    JSON.parse(customerCookie).access_token
                }&ratings=${rating}`
            );
            const resultJson = await result.json();
...
export function getCODEligibility(isPaymentFailed, isFromRetryUrl, retryCartGuid) {
    const userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    const customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
    let cartId;
    ...
    return async (dispatch, getState, { api }) => {
        if (isPaymentFailed) {
            ...
            if (isFromRetryUrl) {
                ...
                const cartDetails = Cookie.getCookie(CART_DETAILS_FOR_LOGGED_IN_USER);
                cartId = cartDetails && JSON.parse(cartDetails).guid ? JSON.parse(cartDetails).guid : null;
            }
        }
        dispatch(getCODEligibilityRequest());
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/payments/getCODEligibility?access_token=${
                    JSON.parse(customerCookie).access_token
...
export function binValidationForCOD(paymentMode, isFromRetryUrl, retryCartGuid) {
    const userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    const customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
...
// Action Creator to update Transaction Details
export function updateTransactionDetailsForCOD(paymentMode, juspayOrderID, isFromRetryUrl, retryCartGuid) {
    const userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    const customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
    const cartDetails = Cookie.getCookie(CART_DETAILS_FOR_LOGGED_IN_USER);
    let whatsappNotification = Cookie.getCookie(WHATSAPP_NOTIFICATION);
...
export function eddInCommerce(reservationItem) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/carts/${cartId}/getEDD?access_token=${
                    JSON.parse(customerCookie).access_token
                }&pincode=${pinCode}`,
                reservationItem
            );
...
export function removeItemFromCartLoggedIn(entryNumber, pinCode, mainProductUssid, isForDigitalBundledProduct) {
    return async (dispatch, getState, { api }) => {
        const userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
        const customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
        ...
        try {
            ...
            dispatch(
                ...
                if (cartDetails.status === SUCCESS) {
                    setDataLayerForCartDirectCalls(ADOBE_REMOVE_ITEM, cartDetails.cartDetails);
...
export function removeItemFromCartLoggedOut(entryNumber, pinCode, mainProductUssid, isForDigitalBundledProduct) {
    return async (dispatch, getState, { api }) => {
        const cartDetailsAnonymous = Cookie.getCookie(CART_DETAILS_FOR_ANONYMOUS);
        const globalCookie = Cookie.getCookie(GLOBAL_ACCESS_TOKEN);
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            dispatch(
                ...
                if (cartDetails.status === SUCCESS) {
                    setDataLayerForCartDirectCalls(ADOBE_CALLS_FOR_CHANGE_QUANTITY, resultJson);
...
export function getBankAndTenureDetails(retryFlagForEmiCoupon, isFromRetryUrl, retryCartGuid, isFromDebitCard = false) {
    return async (dispatch, getState, { api }) => {
        const userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
        const customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
        let cartDetails = "";
        ...
        if (isFromRetryUrl) {
            ...
            cartDetails = Cookie.getCookie(CART_DETAILS_FOR_LOGGED_IN_USER);
            cartId = (cartDetails && JSON.parse(cartDetails).guid) || Cookie.getCookie("oldCartGuId");
        }
        dispatch(getBankAndTenureDetailsRequest());
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/payments/noCostEmiTenureList?access_token=${
                    JSON.parse(customerCookie).access_token
...
export function getEmiTermsAndConditionsForBank(code, bankName) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.get(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/payments/${code}/noCostEmiTnc?access_token=${
                    JSON.parse(customerCookie).access_token
                }`
            );
            const resultJson = await result.json();
...
export function applyNoCostEmiSuccess(noCostEmiResult, couponCode, isFromRetryUrl) {
    return {
...
export function applyNoCostEmi(couponCode, cartGuId, cartId, isFromRetryUrl) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            if (resultJsonStatus.status) {
                if (resultJson.errorCode === ERROR_CODE_FOR_BANK_OFFER_INVALID_3) {
                    const redoCall = () => dispatch(applyNoCostEmi(couponCode, cartGuId, cartId));
            ...
            return dispatch(applyNoCostEmiSuccess(resultJson, couponCode, isFromRetryUrl));
        } catch (e) {
...
export function getItemBreakUpDetails(couponCode, cartGuId, noCostEmiText, noCostEmiProductCount, emiInfo) {
    return async (dispatch, getState, { api }) => {
        const userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
        const customerCookie = Cookie.getCookie(CUSTOMER_ACCESS_TOKEN);
        if (!cartGuId) {
            const cartDetails = JSON.parse(Cookie.getCookie(CART_DETAILS_FOR_LOGGED_IN_USER));
...
export function getPaymentFailureOrderDetails() {
    return async (dispatch, getState, { api }) => {
        ...
        let url = queryString.parse(window.location.search);
        const cartGuId = url && url.value ? url.value : Cookie.getCookie(OLD_CART_GU_ID);

        dispatch(getPaymentFailureOrderDetailsRequest());
        try {
            const result = await api.get(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/payments/failedorderdetails?access_token=${
                    JSON.parse(customerCookie).access_token
            ...
            await Cookie.createCookie(CART_DETAILS_FOR_LOGGED_IN_USER, JSON.stringify({ guid: cartGuId }));
            // dispatch(getMinicartProducts());
        } catch (e) {
...
export function getTncForBankOffer() {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.get(`v2/mpl/paymentSpecificOffersTermsAndCondition?isPwa=true`);
            const resultJson = await result.json();
            const resultJsonStatus = ErrorHandling.getFailureResponse(resultJson);
            if (resultJsonStatus.status) {
                throw new Error(resultJsonStatus.message);
...
export function getValidDeliveryModeDetails(cartProductDetails, isFromRetryUrl, pincodeDetails) {
    ...
    */
    ...
    Object.keys(selectedDeliverMode).forEach(productMode => {
        if (selectedDeliverMode[productMode] === HOME_DELIVERY || selectedDeliverMode[productMode] === "HD") {
            updatedDeliveryModes[productMode] = SHORT_HOME_DELIVERY;
        } else if (selectedDeliverMode[productMode] === EXPRESS || selectedDeliverMode[productMode] === "ED") {
        ...
        } else if (selectedDeliverMode[productMode] === COLLECT || selectedDeliverMode[productMode] === "CNC") {
    ...
    each(allProducts, product => {
        if (product.isGiveAway === NO || isFromRetryUrl) {
            ...
            if (isFromRetryUrl) {
                selectedDeliveryModeDetails = pincodeDetails.pinCodeResponseList[index].validDeliveryModes.find(
                    validDeliveryMode => {
                        return validDeliveryMode.type === updatedDeliveryModes[product.USSID];
                    }
                );
            } else {
                selectedDeliveryModeDetails = product.pinCodeResponse.validDeliveryModes.find(validDeliveryMode => {
                    return validDeliveryMode.type === updatedDeliveryModes[product.USSID];
                });
            }
            index++;
            ...
            productDetails.deliveryMode = selectedDeliveryModeDetails && selectedDeliveryModeDetails.type;
            if (selectedDeliveryModeDetails && selectedDeliveryModeDetails.serviceableSlaves) {
                productDetails.serviceableSlaves = selectedDeliveryModeDetails.serviceableSlaves;
            } else if (selectedDeliveryModeDetails && selectedDeliveryModeDetails.CNCServiceableSlavesData) {
                let selectedStoreDetails =
                    selectedDeliveryModeDetails &&
                    selectedDeliveryModeDetails.CNCServiceableSlavesData.find(storeDetails => {
                        if (isFromRetryUrl) {
                ...
                productDetails.serviceableSlaves = selectedStoreDetails && selectedStoreDetails.serviceableSlaves;
            }
        ...
        try {
            ...
            if (productDetails.isCNC) {
                result = await api.get(
                    `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/buyNow/expressBuy?productCode=${
                        productDetails.code
                    }&USSID=${productDetails.ussId}&slaveId=${productDetails.slaveId}&access_token=${
                        JSON.parse(customerCookie).access_token
                    }&isCNC=yes&isMDE=true`
                );
            } else {
                result = await api.get(
                    `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/buyNow/expressBuy?access_token=${
                        JSON.parse(customerCookie).access_token
                    }&isPwa=true&channel=${CHANNEL}&productCode=${productDetails.code}&USSID=${
            ...
            localStorage.setItem(CART_BAG_DETAILS, JSON.stringify([productDetails.ussId]));
...
export function mergeTempCartWithOldCart() {
    ...
    return async (dispatch, getState, { api }) => {
      ...
      */
        ...
        try {
            const result = await api.get(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/buyNow/mergeBuyNowCart?access_token=${
                    JSON.parse(customerCookie).access_token
    ...
    return async dispatch => {
        if (!cartDetails.isBuyNowCart) {
            ...
            if (getCartIdResponse.status === SUCCESS) {
                Cookie.createCookie(CART_DETAILS_FOR_LOGGED_IN_USER, JSON.stringify(getCartIdResponse.cartDetails));
...
export function getFeedBackForm(getUserDetails, isReturnFlow) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const { originalUid, transactionId, deliveryMode, returnType, rating } = getUserDetails;
            let result = null;
            ...
            if (isReturnFlow) {
                ...
                result = await api.post(`v2/mpl/getQuestionsForReturnNPS`, returnParamsObj);
            } else {
                result = await api.get(
...
export function postFeedBackForm(commemt, questionRatingArray, transactionId, originalUid, isReturnFlow) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            let apiEndPoint = isReturnFlow ? "submitReturnNPSFeedback" : "getFeedbackCapturedData";
...
export function getIntermittentPageData(getUserDetails) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            let { originalUid, transactionId, deliveryMode, returnType } = getUserDetails;
            let paramsObj = {},
...
export function getUserAddressAndDeliveryModesByRetryPaymentSuccess(getUserAddressAndDeliveryModesByRetryPayment) {
    return {
...
export function getUserAddressAndDeliveryModesByRetryPayment(guId) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            return dispatch(getUserAddressAndDeliveryModesByRetryPaymentSuccess(resultJson));
        } catch (e) {
            return dispatch(getUserAddressAndDeliveryModesByRetryPaymentFailure(e.message));
        }
    };
}
...
export function getCartCountForLoggedInUser(cartVal) {
    ...
    let cartGuid = cartDetails && JSON.parse(cartDetails).guid ? JSON.parse(cartDetails).guid : null;

    if (cartVal) {
        cartGuid = cartVal.cartDetails && cartVal.cartDetails.guid ? cartVal.cartDetails.guid : cartVal.guid;
    }
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            return dispatch(getCartCountForLoggedInUserSuccess(resultJson, userDetails));
        } catch (e) {
...
export function getOrderUpdateOnWhatsapp(orderId) {
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.get(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/updateOrderPreferences/${orderId}?access_token=${
                    JSON.parse(customerCookie).access_token
...
export function collectPaymentOrderForGiftCardSuccess(collectPaymentOrder, guid) {
    return {
...
export function stripeTokenize(cardDetails) {
    return async (dispatch, getState, { api }) => {
...
export function createPaymentOrder(guId) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                `${USER_CART_PATH}/${JSON.parse(userDetails).userName}/payments/createPaymentOrder?access_token=${
                    JSON.parse(customerCookie).access_token
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            const result = await api.post(
                ...
                }&cardBrandName=${cardBrandName}${whatsappNotification ? "&whatsapp=true" : ""}&dcemi=${dcemi}`,
                cartdetails
            );
            const resultJson = await result.json();
            const resultJsonStatus = ErrorHandling.getFailureResponse(resultJson);
            ...
            if (resultJson.pspName === "Juspay") {
                dispatch(jusPayPaymentMethodType(resultJson.pspAuditId, cardDetails, paymentMode));
...
export function getPrepaidOrderPaymentConfirmation(orderDetails) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            const resultJson = await result.json();
            const resultJsonStatus = ErrorHandling.getFailureResponse(resultJson);
            if (resultJsonStatus.status || resultJson.paymentStatus.toLowerCase() === FAILURE_LOWERCASE) {
                throw new Error(resultJsonStatus.message);
            }
    ...
    return async (dispatch, getState) => {
        ...
        if (cardDetails) {
            let juspayToken = await dispatch(
                jusPayTokenize(cardDetails, address, inventoryItems, paymentMode, isPaymentFailed)
            );
            let stripeToken = await dispatch(stripeTokenize(cardDetails, address, cartItems, paymentMode));
            ...
            let stripe_token_details = {
                ...
                cardCountry: stripeToken && stripeToken.card && stripeToken.card.country,
                cardFingerprint: stripeToken && stripeToken.card && stripeToken.card.fingerprint,
                cardRefNo: "",
                returnUrl: returnUrl,
            };
            let cardBrandName = stripeToken && stripeToken.card && stripeToken.card.brand;
            orderDetails.wrapperItems[0].wrapperPspItems = [{ pspItems: [juspay_token_details, stripe_token_details] }];
            dispatch(
                collectPaymentOrder(
                    cardDetails,
                    address,
...
export function stripe_juspay_TokenizeGiftCard(cardDetails, paymentMode, egvCartGuid, isFromRetryUrl) {
    return async dispatch => {
        const returnUrl = `${window.location.origin}/checkout/payment-method/cardPayment`;
        if (cardDetails) {
            let juspayToken = await dispatch(jusPayTokenizeForGiftCard(cardDetails, paymentMode, egvCartGuid));
            ...
            orderDetails.wrapperItems[0].wrapperPspItems = [{ pspItems: [juspay_token_details, stripe_token_details] }];
            dispatch(
                collectPaymentOrderForGiftCard(cardDetails, egvCartGuid, orderDetails, cardBrandName, isFromRetryUrl)
            );
        }
    };
}
...
export function collectPaymentOrderForSavedCards(
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            dispatch(jusPayPaymentMethodTypeForSavedCards(resultJson.pspAuditId, cardDetails));
        } catch (e) {
            dispatch(displayToast(ERROR_MESSAGE_FOR_CREATE_JUS_PAY_CALL + " Please Retry."));
            dispatch(collectPaymentOrderFailure(e));
        }
...
export function collectPaymentOrderForGiftCardFromSavedCards(cardDetails, guId) {
    return async (dispatch, getState, { api }) => {
        let browserName = browserAndDeviceDetails.getBrowserAndDeviceDetails(1);
        let fullVersion = browserAndDeviceDetails.getBrowserAndDeviceDetails(2);
        let deviceInfo = browserAndDeviceDetails.getBrowserAndDeviceDetails(3);
        ...
        try {
            ...
            dispatch(jusPayPaymentMethodTypeForGiftCardFromSavedCards(resultJson.pspAuditId, cardDetails, guId));
        } catch (e) {
            dispatch(displayToast(ERROR_MESSAGE_FOR_CREATE_JUS_PAY_CALL + " Please Retry."));
...
export function collectPaymentOrderForNetBanking(
    ...
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            if (localStorage.getItem(PAYMENT_MODE_TYPE) === PAYPAL) {
                dispatch(jusPayPaymentMethodTypeForPaypal(paymentMethodType, resultJson.pspAuditId, bankCode));
            } else if (localStorage.getItem(PAYMENT_MODE_TYPE) === "Instacred") {
                dispatch(jusPayPaymentMethodTypeForInstaCred(paymentMethodType, resultJson.pspAuditId, bankCode));
            } else {
                dispatch(jusPayPaymentMethodTypeForNetBanking(paymentMethodType, resultJson.pspAuditId, bankCode));
            }
        } catch (e) {
            dispatch(displayToast(ERROR_MESSAGE_FOR_CREATE_JUS_PAY_CALL + " Please Retry."));
            dispatch(collectPaymentOrderFailure(e));
...
export function collectPaymentOrderForGiftCardNetBanking(egvCartGuid, bankCode, bankName) {
    return async (dispatch, getState, { api }) => {
        ...
        try {
            ...
            dispatch(jusPayPaymentMethodTypeForGiftCardNetBanking(resultJson.pspAuditId, bankCode, egvCartGuid));
        } catch (e) {
...
export function collectPaymentOrderForCliqCashSuccess(collectPaymentOrder, guid) {
    return {
...
export function collectPaymentOrderForCliqCash(pinCode, cartItem, isPaymentFailed = false) {
    return async (dispatch, getState, { api }) => {
        let browserName = browserAndDeviceDetails.getBrowserAndDeviceDetails(1);
        let fullVersion = browserAndDeviceDetails.getBrowserAndDeviceDetails(2);
        let deviceInfo = browserAndDeviceDetails.getBrowserAndDeviceDetails(3);
        ...
        try {
            ...
            if (resultJson.errorCode === ERROR_CODE_FOR_BANK_OFFER_INVALID_7) {
                ...
                if (
                    ...
                    dispatch(collectPaymentOrderForCliqCashFailure(INVALID_COUPON_ERROR_MESSAGE));
                    return dispatch(
                        showModal(INVALID_BANK_COUPON_POPUP, {
                            result: resultJson,
                        })
...
export function removeExchange(data) {
    return async (dispatch, getState, { api }) => {
        ...
        const userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
        const cartDetailsCookie = Cookie.getCookie(CART_DETAILS_FOR_LOGGED_IN_USER);
        const cartDetailsForAnonymous = Cookie.getCookie(CART_DETAILS_FOR_ANONYMOUS);
        const defaultPinCode = localStorage.getItem(DEFAULT_PIN_CODE_LOCAL_STORAGE);
        let user = "anonymous";
        let cartId = cartDetailsForAnonymous && JSON.parse(cartDetailsForAnonymous).guid;
        let guId = cartId;
        ...
        try {
            ...
            if (resultJson && resultJson.status && resultJson.status.toLowerCase() === "failure") {
                if (resultJson.error && resultJson.errorCode && resultJson.errorCode === "EX05") {
                    dispatch(displayToast(resultJson.error));
                }
...
export function getEMIEligibilityDetails(cartGuId) {
    if (!cartGuId) {
        ...
        cartGuId = (cartDetails && JSON.parse(cartDetails).guid) || Cookie.getCookie("oldCartGuId");
    }
    let userDetails = Cookie.getCookie(LOGGED_IN_USER_DETAILS);
    return async (dispatch, getState, { api }) => {
...
export function submitAppliancesExchangeData(orderId, status, removeLocalStorage, apiCallCount = 0) {
    let cartExchangeDetails = localStorage.getItem(AC_CART_EXCHANGE_DETAILS);
        ...
        try {
            ...
            if (result.status === 200) {
                ...
                if (apiCallCount === 0) {
                    ...
                    dispatch(submitAppliancesExchangeData(orderId, status, removeLocalStorage, apiCallCount));
                } else {
...
export function mdeFraudCheckRequest() {
    return {
        type: MDE_FRAUD_CHECK_REQUEST,
        status: REQUESTING,
    };
}

export function mdeFraudCheckSuccess(data) {
    return {
        type: MDE_FRAUD_CHECK_SUCCESS,
        status: SUCCESS,
        data,
    };
}

export function mdeFraudCheckFailure(error) {
    return {
        type: MDE_FRAUD_CHECK_FAILURE,
        status: ERROR,
        error,
    };
}

export function mdeFraudCheck() {
    const loggedInUserDetails = getLoggedInUserDetails();
    const accessToken = getCustomerAccessTokenService();
    const cartDetails = getCartDetailsForLoggedInUser();

    return async (dispatch, getState, { api }) => {
        dispatch(mdeFraudCheckRequest());
        try {
            const result = await api.get(
                `${CART_PATH}/${loggedInUserDetails.userName}/mdeFraudCheck?access_token=${accessToken}&cartGuid=${cartDetails.guid}`
            );
            const resultJson = await result.json();
            if (
                resultJson &&
