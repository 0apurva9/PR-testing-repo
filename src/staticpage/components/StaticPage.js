...
export default class StaticPage extends Component {
    ...
    render() {
        ...
        if (staticPageTextComponent || aboutUsText || aboutUsImage || listTitle || listMenu) {
            return (
                    ...
                    <DesktopOnly>
                        {this.props.location.pathname !== "/aboutus" && (
                            <div
                                ...
                                style={{
                                    maxWidth: this.props.location.pathname === "/contact" ? "" : "1200px",
                                    margin: this.props.location.pathname === "/contact" ? "" : "auto",
                                    paddingTop: this.props.location.pathname === "/contact" ? "0px" : "60px",
                                }}
                            >
                                    ...
                                    this.props.location.pathname !== "/aboutus" && (
                                        <React.Fragment>
                                            {listTitle && listTitle.title && (
                                                <div className={styles.header}>{listTitle && listTitle.title}</div>
                                            )}
                                        </React.Fragment>
                                    )}
                                <div
                                    ...
                                    style={{
                                        paddingBottom: this.props.location.pathname === "/contact" ? "0px" : "80px",
                                    }}
                                >
                                    {this.props.location.pathname === "/contact" && (
                                ...
                                {this.props.location.pathname !== "/contact" && (
                                    ...
                                    >
                                        <div className={styles.sectionPart} onClick={() => this.onClick(CONTACT_URL)}>
                                            <div className={styles.iconHolder}>
                                                <Icon image={contactUsIcon} size={30} />
                                            </div>
                                            <div className={styles.sectionLabel}>Contact us</div>
                                        </div>
                                        <div className={styles.sectionPart} onClick={() => this.onClick(ABOUT_US_URL)}>
                                            <div className={styles.iconHolder}>
