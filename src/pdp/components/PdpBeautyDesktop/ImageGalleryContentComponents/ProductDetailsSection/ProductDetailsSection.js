...
import(/* webpackChunkName: "ColorComponent" */ "./color-component.component.jsx");
const ColorComponent = Loadable({
    loader: () => import(/* webpackChunkName: "ColorComponent" */ "./color-component.component.jsx"),
    loading() {
        return <Loader />;
    },
});
...
const typeComponentMapping = {
    [PRODUCT_AND_BRAND_COMPONENT]: props => <ProductAndBrandComponent {...props} />,
