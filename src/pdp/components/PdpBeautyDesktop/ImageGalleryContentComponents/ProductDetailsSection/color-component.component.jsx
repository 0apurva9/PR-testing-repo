...
export default class ColorComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        if (
            ((variantTheme && variantTheme.length > 0) || (variantOptions && variantOptions.length > 0)) &&
            productListingId
        ) {
    ...
    render() {
        ...
        const pincodeListResponse =
            ...
            this.props.productDetails.pincodeListResponse.deliveryOptions.pincodeListResponse
                ? this.props.productDetails.pincodeListResponse.deliveryOptions.pincodeListResponse
                : [];
        ...
        if (this.state.selectedSizeIndex >= 0) {
            selectedSizeColorOptions =
                variantTheme && variantTheme.length > 0 && variantTheme[this.state.selectedSizeIndex].colorOptions;
                                        ...
                                        return (
                                            <div key={i}>
                                                <div className={styles["shade-subheading"]}>
                                                    {colorAndSize.sizelink.size && colorAndSize.sizelink.size}
                                                </div>
                                                <React.Fragment>
