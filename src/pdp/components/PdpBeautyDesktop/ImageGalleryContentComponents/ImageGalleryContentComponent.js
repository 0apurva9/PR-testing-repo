...
import { IMAGE_GALLERY_COMPONENT, SECTION_OF_PRODUCT_DETAILS } from "../ComponentConstants";
...
export default class ImageGalleryContentComponent extends React.Component {
    ...
    render() {
        const galleryCompDetails =
            ...
            this.props.compDetails.filter(compItem => compItem.componentId === IMAGE_GALLERY_COMPONENT);
