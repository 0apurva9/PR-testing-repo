            ...
            <div className={styles.base}>
                {this.props.isPublishedReview && this.props.canEditDelete ? (
                    <div
                        ...
                        onClick={() => this.editRatingReview(this.props.productcode, this.props.userRating)}
                    >
                ...
                {!this.props.isPendingForApproval && !this.props.isPublishedReview ? (
                    <div className={styles.reviewHolder}>
                            ...
                            {this.props.userRating && this.props.isRated ? (
                                <RatingAndIconComponent
                                    ...
                                    showRatingReviewModal={() =>
                                        this.props.showRatingReviewModal(this.props.productcode, this.props.userRating)
                                    }
                                />
                            ) : (
                        ...
                        {!this.props.isReviewed && this.props.isRated && this.props.userRating ? (
                            <React.Fragment>
                                {this.props.isParamConfigured &&
                                !this.props.isParamRatingPresent &&
                                ("reviewStatus" in this.props ? this.props.reviewStatus !== "rejected" : true) ? (
