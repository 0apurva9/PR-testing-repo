...
export default class PdpElectronics extends React.Component {
    ...
    addToCart = async buyNowFlag => {
        ...
        if (!this.props.productDetails.winningSellerPrice) {
            ...
            if (this.props.productDetails.allOOStock || this.props.productDetails.winningSellerAvailableStock === "0") {
    ...
    render() {
        ...
        if (productData) {
            ...
            if (productData.mrpPrice && productData.mrpPrice.doubleValue) {
                ...
                discountPdp = Math.round(((mrpDoubleValue - seoDoublePrice) / mrpDoubleValue) * 100);
            }
            ...
            return (
                ...
                >
                    ...
                    <div className={styles.gallery}>
                        <ProductGalleryMobile paddingBottom={productData.rootCategory === "Watches" ? "114" : "89.4"}>
                            {mobileGalleryImages.map((val, idx) => {
                                return (
                                    <Image
                                        image={val}
                                        key={idx}
                                        color={productData.rootCategory === "Watches" ? "#ffffff" : "#f5f5f5"}
                                        fit="contain"
                                    />
                                );
                            })}
                    ...
                    <div className={productData.rootCategory !== "Watches" ? styles.whiteBackground : styles.base}>
              ...
              />
                    ...
                    {productData.rootCategory !== "Watches" && (
                        <div className={styles.details}>
                            {productData.details && (
                                <Accordion text="Product Description" headerFontSize={16} isOpen={true}>
                            ...
                            {productData.brandInfo && (
                                <ProductFeature heading="Brand Info" content={productData.brandInfo} />
                            )}
                        </div>
                    )}
                    {productData.rootCategory === "Watches" && (
                        <div className={styles.details}>
                            ...
                            {productData.classifications && (
                                <Accordion text="Features & Functions" headerFontSize={16} isOpen={false}>
                    ...
                    {productData.rootCategory !== "Watches" && (
                        <div className={styles.details}>
                            {productData.classifications && <ProductFeatures features={productData.classifications} />}
                        </div>
                    )}
                    {productData.rootCategory === "Watches" && (
                        <div className={styles.details}>
                            {productData.details && <ProductDetails data={productData.details} />}
                            {productData.warranty && productData.warranty.length > 0 && (
                                <ProductFeature heading="Warranty" content={productData.warranty[0]} />
                            )}
                        </div>
                    )}
