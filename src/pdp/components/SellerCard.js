...
export default class SellerCard extends React.Component {
    ...
    render() {
        ...
        if (this.props.discountPrice && this.props.price !== this.props.discountPrice) {
                ...
                <MobileOnly>
                    <div className={styles.textBox}>
                        <div className={this.props.disabled ? styles.faded : styles.buffer}>
                            ...
                            {this.props.price && <span className={priceClass}>{this.props.price}</span>}
                            {this.props.hasEmi && <div className={styles.offerText}>EMI Available</div>}
                        </div>
                    </div>
                    <div className={styles.textBox2}>
                        <div className={this.props.disabled ? styles.faded : styles.buffer}>
                            ...
                            {this.props.hasCod && <div className={styles.offerText}>{this.props.cashText}</div>}
                        </div>
                    </div>
                </MobileOnly>
                <DesktopOnly>
                    <div className={this.props.disabled ? styles.faded : styles.sellerCardDetails}>
                    ...
                    <div className={this.props.disabled ? styles.faded : styles.sellerCardDetails}>
                        ...
                        {this.props.price && <span className={priceClass}>{this.props.price}</span>}
                        {this.props.hasEmi && <div className={styles.offerText}>EMI Available</div>}
                        {this.props.hasCod && <div className={styles.offerText}>COD Available</div>}
                    </div>
                    <div className={this.props.disabled ? styles.faded : styles.sellerCardDetails}>
                        ...
                        {this.props.exchangeAvailable && (
                            <React.Fragment>
                                ...
                                <div className={styles.exchangeProduct}>Exchange Your Old Phone</div>
                                <div className={styles.buttonWithArrow} onClick={() => this.openExchangeModal()}>
                        ...
                        <div className={styles.buttonHolder}>
                            <div className={styles.button}>
                                <Button
                                    ...
                                    onClick={this.state.goToBagFlag ? () => this.goToCart() : () => this.addToBag()}
                                    width={160}
