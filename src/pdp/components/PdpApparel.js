...
export default class PdpApparel extends React.Component {
    ...
    render() {
        ...
        if (productData) {
            ...
            return (
                <PdpFrame
                    goToCartPageFlag={this.props.location.state && this.props.location.state.goToCartPageFlag}
            ...
            <Overlay labelText="This size is currently out of stock. Please select another size or try another product.">
              ...
              />
                    ...
                    {productData.APlusContent && (
                        <AllDescription productContent={productData.APlusContent.productContent} />
                    )}
                    <div className={styles.details} />
