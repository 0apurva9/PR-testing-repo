        ...
        return (
            <div className={styles.base}>
                ...
                <div className={styles.productDescriptionHolder}>
                    ...
                    <a itemProp="url" style={{ cursor: "pointer" }} onClick={() => this.onClickImage()}>
                        <div itemProp="name">
                    ...
                    >
                        ...
                        <meta
                            ...
                            content={this.props.numberOfReviews ? this.props.numberOfReviews : 0}
                        />
                        <meta
                            itemProp="itemReviewed"
                            content={this.props.averageRating ? this.props.averageRating : 0}
                        />
                        {this.props.averageRating && <StarRating averageRating={this.props.averageRating} />}
                    </div>
