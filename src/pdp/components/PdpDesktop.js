...
export default class PdpApparel extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            nextProps.appliancesExchangePincodeDetails.status.toLowerCase() === SUCCESS &&
            nextProps.appliancesExchangePincodeDetails !== this.state.isPickupAvailableForAppliance
        ) {
            let data =
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.updatedAppliancesExchangeDetails !== prevProps.updatedAppliancesExchangeDetails) {
            this.setState({
                updatedAppliancesExchangeDetails: this.props.updatedAppliancesExchangeDetails,
            });
        }
    }
    ...
    renderDetails(filteredData) {
        return filteredData.map((val, idx) => {
            return (
                            ...
                            <div className={styles.content}>
                                <div className={styles.horizontalOffset}>
                                    <div className={styles.breadcrumbs}>
                                        ...
                                        {reverseBreadCrumbs &&
                                            reverseBreadCrumbs.map((val, idx) => {
                                                return (
                                                    <div
                                ...
                                {!this.state.showGotoCartButton && (
                                    <div className={styles.buttonWrapper}>
                                        <div
                                            className={
                                                this.state.isLoader ? styles.nonClickButton : styles.buttonHolder
                                            }
                                        >
                                            {this.state.isLoader && (
                                        ...
                                        <div className={styles.sumsungSeparator}>
                                            <div className={styles.chatIcon}>
                                                ...
                                                <div className={styles.chatText}>
                                                    <p>
                                                        Chat with the Samsung brand representative directly for more
                                                        info
                                                    </p>
                                                    <a href={samsungChatUrl} target="_blank" rel="noreferrer">
                                                        Click here to chat
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            productData.classificationList && (
                                                <Accordion text="Overview" headerFontSize={18}>
                                                    <div className={styles.accordionContent}>
                                                        {productData.classificationList &&
                                                            productData.classificationList.map((value, idx) => {
                                                                return (
...
PdpApparel.propTypes = {
    ...
    productDetails: PropTypes.shape({
        bundlingSuggestionAvailable: PropTypes.bool,
        ...
        showPriceBrkUpPDP: PropTypes.string,
        potentialPromotions: PropTypes.object,
        numberOfReviews: PropTypes.number,
        isOfferExisting: PropTypes.bool,
        isOnlineExclusive: PropTypes.bool,
        isProductNew: PropTypes.bool,
        productOfferMsg: PropTypes.object,
        seStartingPrice: PropTypes.number,
        galleryImagesList: PropTypes.array,
        nceAvailable: PropTypes.bool,
        nceStartingPrice: PropTypes.number,
        isEMIEligible: PropTypes.bool,
        isCOD: PropTypes.bool,
        buyingGuideUrl: PropTypes.string,
        isSizeOrLength: PropTypes.bool,
        maxQuantityAllowed: PropTypes.bool,
        showExchangeTag: PropTypes.bool,
        exchangeOfferAvailable: PropTypes.bool,
        exchangeAvailable: PropTypes.bool,
        isServiceableToPincode: PropTypes.object,
        serviceableSellerMessage: PropTypes.string,
        seasonDetails: PropTypes.array,
        variantOptions: PropTypes.array,
        mrpPrice: PropTypes.object,
        details: PropTypes.array,
        prdDetails: PropTypes.array,
        isPickupAvailableForExchange: PropTypes.bool,
        pincodeResponseList: PropTypes.object,
        certificationMapFrJwlry: PropTypes.bool,
        winningSellerName: PropTypes.string,
        deliveryModesATP: PropTypes.string,
        styleNote: PropTypes.string,
        classificationList: PropTypes.array,
        classifications: PropTypes.array,
        fineJewelleryClassificationList: PropTypes.array,
        priceBreakUpDetailsMap: PropTypes.array,
        knowMore: PropTypes.array,
        warranty: PropTypes.array,
        brandInfo: PropTypes.object,
        APlusContent: PropTypes.object,
        ...
        returnAndRefund: PropTypes.array,
        knowMoreV2: PropTypes.array,
    ...
    getAppliancesExchangeDetails: PropTypes.func,
    ...
    addBundledProductsToCart: PropTypes.bool,
