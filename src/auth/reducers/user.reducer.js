...
const user = (
    ...
    switch (action.type) {
        ...
        case userActions.LOGIN_USER_FAILURE:
            ...
            Cookies.createCookie(NON_LOGGED_IN_USER_DETAILS, JSON.stringify(userDetails));
            return Object.assign({}, state, {
                status: action.status,
                error: action.error,
                loading: false,
        ...
        case userActions.CUSTOMER_ACCESS_TOKEN_SUCCESS:
            ...
            // if(!action.customerAccessTokenDetails.refresh_token){
        ...
        case userActions.REFRESH_TOKEN_SUCCESS:
            ...
            Cookies.createCookie(
                CUSTOMER_ACCESS_TOKEN,
                JSON.stringify(action.customerAccessTokenDetails),
                action.customerAccessTokenDetails.expiresIn
            );
            localStorage.setItem(REFRESH_TOKEN, action.customerAccessTokenDetails.refreshToken);
