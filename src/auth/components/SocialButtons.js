...
export default class SocialButtons extends Component {
    ...
    render() {
        let titleText = this.props.type === SOCIAL_SIGN_UP ? this.props.titleTextSignIp : this.props.titleTextLogin;
        return (
                ...
                <MediaQuery query="(min-device-width: 1025px)">
                    <div className={styles.socialButtonHolder}>
                        <div className={styles.holder}>
                            <div className={styles.facebookImageHolderDesktop} onClick={this.facebookLogin} />
                        </div>
                        <div className={styles.separator} />
                        <div className={styles.holder}>
                            <div className={styles.googleImageForDesktop} onClick={this.googlePlusLogin} />
                        </div>
                    </div>
                </MediaQuery>
