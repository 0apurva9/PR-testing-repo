...
import { facebookLogin, googlePlusLogin, getGlobalAccessToken, refreshToken } from "./auth/actions/user.actions";
import {
...
const mapStateToProps = (state) => {
    return {
        ...
        refreshCustomerAccessTokenStatus: state.user.refreshCustomerAccessTokenStatus,
